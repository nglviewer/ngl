...
d.clear().add(new UI.Text(a))});a.viewer.stats.signals.updated.add(function(){e.clear().add(new UI.Text(a.viewer.stats.lastDuration.toFixed(2)+" ms | "+a.viewer.stats.lastFps+" fps"))});c.add(d);NGL.debug&&c.add(e);return c};
