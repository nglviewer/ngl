...
var g=(new NGL.SidebarWidget(a)).setId("sidebar");document.body.appendChild(g.dom);document.body.addEventListener("touchmove",function(a){a.preventDefault()},!1);a.handleResize();setTimeout(function(){a.handleResize()},500);var h=!1,k=!1,l=!1,n=function(b){50<=b&&b<=window.innerWidth-10&&(g.setWidth(window.innerWidth-b+"px"),e.setWidth(b+"px"),f.setWidth(b+"px"),a.handleResize());var c=g.dom.getBoundingClientRect().width;void 0===b&&(b=window.innerWidth-c,e.setWidth(b+"px"),f.setWidth(b+"px"),a.handleResize());
l=10>=c?!0:!1},n=NGL.throttle(n,50,{leading:!0,trailing:!0}),r=(new UI.Panel).setClass("ResizeLeft").onMouseDown(function(){h=!0;k=!1}).onClick(function(){l?n(window.innerWidth-300):h||k||n(window.innerWidth-10)});g.add(r);window.addEventListener("mousemove",function(a){h&&(document.body.style.cursor="col-resize",k=!0,n(a.clientX))},!1);window.addEventListener("mouseup",function(a){h=!1;document.body.style.cursor=""},!1);window.addEventListener("resize",function(a){n()},!1);document.addEventListener("dragover",
...
NGL.MenubarFileWidget=function(a){function b(){var b=NGL.DatasourceRegistry.listing,c;c=new NGL.DirectoryListingWidget(b,a,"Import file",d,function(e){var f=e.path.split(".").pop().toLowerCase();-1!==d.indexOf(f)?(a.loadFile(b.getUrl(e.path),{defaultRepresentation:!0}),c.dispose()):NGL.log("unknown filetype: "+f)});c.setOpacity("0.9").setLeft("50px").setTop("80px").attach()}var c="pdb ent pqr gro cif mcif mmcif sdf mol2 mrc ccp4 map cube dx dxbin obj ply ngl gz lzma bz2 zip".split(" "),d=c,e=document.createElement("input");
e.type="file";e.multiple=!0;e.style.display="none";e.accept="."+c.join(",.");e.addEventListener("change",function(b){async.eachLimit(b.target.files,4,function(b,c){a.loadFile(b,{defaultRepresentation:!0}).then(function(){c()})})},!1);var f=(new NGL.ExportImageWidget(a)).setDisplay("none").attach(),c=UI.MenubarHelper.createOption,g=UI.MenubarHelper.createInput,h=UI.MenubarHelper.createCheckbox,k=UI.MenubarHelper.createDivider,g=[c("Open...",function(){e.click()}),g("PDB",function(b){13===b.keyCode&&
(a.loadFile("rcsb://"+b.target.value,{defaultRepresentation:!0}),b.target.value="")}),h("asTrajectory",!1,function(b){a.defaultFileParams.asTrajectory=b.target.checked}),h("firstModelOnly",!1,function(b){a.defaultFileParams.firstModelOnly=b.target.checked}),h("cAlphaOnly",!1,function(b){a.defaultFileParams.cAlphaOnly=b.target.checked}),h("reorderAtoms",!1,function(b){a.defaultFileParams.reorderAtoms=b.target.checked}),h("dontAutoBond",!1,function(b){a.defaultFileParams.dontAutoBond=b.target.checked}),
k(),c("Screenshot",function(){a.viewer.screenshot({factor:1,type:"image/png",quality:1,antialias:!0,transparent:!1,trim:!1})},"camera"),c("Export image...",function(){f.setOpacity("0.9").setLeft("50px").setTop("80px").setDisplay("block")})];NGL.DatasourceRegistry.listing&&g.splice(1,0,c("Import...",b));c=UI.MenubarHelper.createOptionsPanel(g);c.dom.appendChild(e);return UI.MenubarHelper.createMenuContainer("File",c)};
...
{__AU:"AU"};Object.keys(a.structure.biomolDict).forEach(function(a){b[a]=a});return b}()).setValue(a.structure.defaultAssembly).onChange(function(){a.structure.setDefaultAssembly(k.getValue());a.rebuildRepresentations();m.setMenuDisplay("none")}),l=document.createElement("input");l.type="file";l.multiple=!0;l.style.display="none";l.accept=".dcd,.dcd.gz";l.addEventListener("change",function(b){async.eachLimit(b.target.files,4,function(b,c){var d=NGL.autoLoad(b).then(function(a){c();return a});a.addTrajectory(d)})},
