...
(new Tether({element:d.dom,target:c.dom,attachment:"top right",targetAttachment:"top left",offset:"0px 5px",constraints:[{to:"window",attachment:"element"}]})).position())});this.add(c);this.setClass("").setDisplay("inline");this.icon=c;this.panel=d;this.entryLabelWidth="100px";return this};UI.PopupMenu.prototype=Object.create(UI.Panel.prototype);UI.PopupMenu.prototype.addEntry=function(a,b){this.panel.add((new UI.Text(a)).setWidth(this.entryLabelWidth)).add(b||new UI.Panel).add(new UI.Break);return this};
UI.PopupMenu.prototype.setEntryLabelWidth=function(a){this.entryLabelWidth=a;return this};UI.PopupMenu.prototype.setMenuDisplay=function(a){this.panel.setDisplay(a);return this};UI.PopupMenu.prototype.setIconTitle=function(a){this.icon.setTitle(a);return this};UI.PopupMenu.prototype.dispose=function(){this.panel.dispose();UI.Element.prototype.dispose.call(this)};
