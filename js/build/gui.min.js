...
var g=(new NGL.SidebarWidget(a)).setId("sidebar");document.body.appendChild(g.dom);a.handleResize();setTimeout(function(){a.handleResize()},500);var h=!1,k=!1,l=!1,m=function(b){50<=b&&b<=window.innerWidth-10&&(g.setWidth(window.innerWidth-b+"px"),e.setWidth(b+"px"),f.setWidth(b+"px"),a.handleResize());var c=g.dom.getBoundingClientRect().width;void 0===b&&(b=window.innerWidth-c,e.setWidth(b+"px"),f.setWidth(b+"px"),a.handleResize());l=10>=c?!0:!1},m=NGL.throttle(m,50,{leading:!0,trailing:!0}),r=(new UI.Panel).setClass("ResizeLeft").onMouseDown(function(){h=
!0;k=!1}).onClick(function(){l?m(window.innerWidth-300):h||k||m(window.innerWidth-10)});g.add(r);window.addEventListener("mousemove",function(a){h&&(document.body.style.cursor="col-resize",k=!0,m(a.clientX))},!1);window.addEventListener("mouseup",function(a){h=!1;document.body.style.cursor=""},!1);window.addEventListener("resize",function(a){m()},!1);document.addEventListener("dragover",function(a){a.stopPropagation();a.preventDefault();a.dataTransfer.dropEffect="none"},!1);document.addEventListener("drop",
function(a){a.stopPropagation();a.preventDefault()},!1);this.viewport=e;this.toolbar=f;this.menubar=c;this.sidebar=g;return this};
