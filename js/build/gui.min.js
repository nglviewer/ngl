...
UI.VirtualTable=function(a,b,c,d,e){e=e||{};UI.Panel.call(this);var f=void 0!==e.defaultWidth?e.defaultWidth:30,g=void 0!==e.defaultMargin?e.defaultMargin:5,h=void 0!==e.defaultAlign?e.defaultAlign:"left",k=e.onRowSelect,l=(new UI.Panel).setWhiteSpace("nowrap").setDisplay("inline-block").setOverflow("").setWidth("100%"),m=0,r=[],q=function(a,b){return a-b},t=function(a,b){return a.localeCompare(b)},n=function(b,c){var e;e="string"===typeof a[0][b]?t:q;a.sort(function(a,d){return c?e(d[b],a[b]):e(a[b],
d[b])});s.redraw();return this},p=function(b,c){r.length=0;k&&k(b,c);void 0!==c&&r.push(a[c][0]);s.redraw();return this};d.forEach(function(a){var b=a.width||f,c=a.margin||g,e=(new UI.EllipsisText).setValue(a.name).setWidth(b+"px").setTextAlign(a.align||h).setMarginLeft(c+"px").setMarginRight(c+"px").setCursor("pointer").onClick(function(b){b="ASC"===a.__sortFlag;n(a.index,b);a.__sortFlag=b?"DESC":"ASC"});l.add(e);m+=b+2*c});var s=(new UI.VirtualList(a,b,c,function(b){var c=new UI.Panel;d.forEach(function(e){var d=
a[b][e.index];e.format&&(d=e.format(d));var q=e.width||f,l=e.margin||g,k;k="object"===typeof d?d:(new UI.Text).setValue(d);k.setWidth(q+"px").setTextAlign(e.align||h).setMarginLeft(l+"px").setMarginRight(l+"px").onClick(function(a){if("function"===typeof e.onClick)e.onClick(a,b,d)}).onMouseOver(function(a){if("function"===typeof e.onMouseOver)e.onMouseOver(a,b,d)}).onMouseOut(function(a){if("function"===typeof e.onMouseOut)e.onMouseOut(a,b,d)});c.add(k)});c.setCursor("pointer").onClick(function(a){p(a,
...
b.target.value,{defaultRepresentation:!0}),b.target.value="")}),h("asTrajectory",!1,function(b){a.defaultFileParams.asTrajectory=b.target.checked}),h("firstModelOnly",!1,function(b){a.defaultFileParams.firstModelOnly=b.target.checked}),h("cAlphaOnly",!1,function(b){a.defaultFileParams.cAlphaOnly=b.target.checked}),h("reorderAtoms",!1,function(b){a.defaultFileParams.reorderAtoms=b.target.checked}),h("dontAutoBond",!1,function(b){a.defaultFileParams.dontAutoBond=b.target.checked}),k(),c("Screenshot",
...
NGL.MenubarPluginsWidget=function(a){var b=UI.MenubarHelper.createOption,c=[];NGL.PluginRegistry.names.sort().forEach(function(e){var d=b(e,function(){NGL.PluginRegistry.load(e,a)});c.push(d)});var d=UI.MenubarHelper.createOptionsPanel(c);return UI.MenubarHelper.createMenuContainer("Plugins",d)};
...
NGL.StructureComponentWidget=function(a,b){function c(){var c={"":"[ structure ]"};b.eachComponent(function(b,d){b!==a&&(c[d]=NGL.unicodeHelper(b.name))},NGL.StructureComponent);q.setOptions(c)}var d=a.signals,e=new UI.CollapsibleIconPanel("file"),f=new UI.Panel,g=new UI.Panel;d.requestGuiVisibility.add(function(a){e.setCollapsed(!a)});d.representationAdded.add(function(a){f.add(new NGL.RepresentationComponentWidget(a,b))});d.trajectoryAdded.add(function(a){g.add(new NGL.TrajectoryComponentWidget(a,
...
NGL.TrajectoryComponentWidget=function(a,b){function c(a){h.clear().add(l.setWidth("70px"));l.setRange(-1,a-1);r.setRange(-1,a-1);m.setValue(Math.ceil((a+1)/100));p.step=m.getValue();p.end=a}var d=a.signals,e=a.trajectory,f=(new UI.CollapsibleIconPanel("database")).setMarginLeft("20px"),g=new UI.Panel;d.representationAdded.add(function(a){g.add(new NGL.RepresentationComponentWidget(a,b))});d.disposed.add(function(){x.dispose();f.dispose()});var h=(new UI.Panel).setMarginLeft("10px").setDisplay("inline").add((new UI.Icon("spinner")).addClass("spin").setMarginRight("69px"));
