...
UI.Integer=function(a){UI.Element.call(this);var b=this,c=document.createElement("input");c.className="Number";c.value="0.00";c.addEventListener("keydown",function(a){a.stopPropagation()},!1);this.min=-Infinity;this.max=Infinity;this.step=1;this.dom=c;this.setValue(a);var d=document.createEvent("HTMLEvents");d.initEvent("change",!0,!0);var e=0,f=0,g=[0,0],h=[0,0],k=function(a){var k=c.value;g=[a.clientX,a.clientY];e+=g[0]-h[0]-(g[1]-h[1]);var q=50;a.shiftKey&&(q=5);a.ctrlKey&&(q=500);c.value=Math.min(b.max,
Math.max(b.min,f+e/q*b.step))|0;k!==c.value&&c.dispatchEvent(d);h=[a.clientX,a.clientY]},l=function(a){document.removeEventListener("mousemove",k,!1);document.removeEventListener("mouseup",l,!1);2>Math.abs(e)&&(c.focus(),c.select())};c.addEventListener("mousedown",function(a){a.preventDefault();e=0;f=parseFloat(c.value);h=[a.clientX,a.clientY];document.addEventListener("mousemove",k,!1);document.addEventListener("mouseup",l,!1)},!1);c.addEventListener("change",function(a){a=parseInt(c.value);!1===
...
a[b][d.index];d.format&&(e=d.format(e));var q=d.width||f,k=d.margin||g,l;l="object"===typeof e?e:(new UI.Text).setValue(e);l.setWidth(q+"px").setTextAlign(d.align||h).setMarginLeft(k+"px").setMarginRight(k+"px").onClick(function(a){if("function"===typeof d.onClick)d.onClick(a,b,e)}).onMouseOver(function(a){if("function"===typeof d.onMouseOver)d.onMouseOver(a,b,e)}).onMouseOut(function(a){if("function"===typeof d.onMouseOut)d.onMouseOut(a,b,e)});c.add(l)});c.setCursor("pointer").onClick(function(a){p(a,
...
b.target.value.trim(),{defaultRepresentation:!0}),b.target.value="")}),h("asTrajectory",!1,function(b){a.defaultFileParams.asTrajectory=b.target.checked}),h("firstModelOnly",!1,function(b){a.defaultFileParams.firstModelOnly=b.target.checked}),h("cAlphaOnly",!1,function(b){a.defaultFileParams.cAlphaOnly=b.target.checked}),h("reorderAtoms",!1,function(b){a.defaultFileParams.reorderAtoms=b.target.checked}),h("dontAutoBond",!1,function(b){a.defaultFileParams.dontAutoBond=b.target.checked}),k(),c("Screenshot",
function(){a.viewer.screenshot({factor:1,antialias:!0,trim:!1,transparent:!1})},"camera"),c("Export image...",function(){f.setOpacity("0.9").setLeft("50px").setTop("80px").setDisplay("block")})];NGL.DatasourceRegistry.listing&&g.splice(1,0,c("Import...",b));c=UI.MenubarHelper.createOptionsPanel(g);c.dom.appendChild(e);return UI.MenubarHelper.createMenuContainer("File",c)};
