...
UI.Number=function(a){UI.Element.call(this);var b=this,c=document.createElement("input");c.className="Number";c.value="0.00";c.addEventListener("keydown",function(a){a.stopPropagation();13===a.keyCode&&c.blur()},!1);this.min=-Infinity;this.max=Infinity;this.precision=2;this.step=1;this.dom=c;this.setValue(a);var d=document.createEvent("HTMLEvents");d.initEvent("change",!0,!0);var e=0,f=0,h=[0,0],g=[0,0],l=function(a){var p=c.value;h=[a.clientX,a.clientY];e+=h[0]-g[0]-(h[1]-g[1]);var m=50;a.shiftKey&&
(m=5);a.ctrlKey&&(m=500);c.value=Math.min(b.max,Math.max(b.min,f+e/m*b.step)).toFixed(b.precision);p!==c.value&&c.dispatchEvent(d);g=[a.clientX,a.clientY]},k=function(a){document.removeEventListener("mousemove",l,!1);document.removeEventListener("mouseup",k,!1);2>Math.abs(e)&&(c.focus(),c.select())};c.addEventListener("mousedown",function(a){a.preventDefault();e=0;f=parseFloat(c.value);g=[a.clientX,a.clientY];document.addEventListener("mousemove",l,!1);document.addEventListener("mouseup",k,!1)},!1);
...
UI.Integer=function(a){UI.Element.call(this);var b=this,c=document.createElement("input");c.className="Number";c.value="0.00";c.addEventListener("keydown",function(a){a.stopPropagation()},!1);this.min=-Infinity;this.max=Infinity;this.step=1;this.dom=c;this.setValue(a);var d=document.createEvent("HTMLEvents");d.initEvent("change",!0,!0);var e=0,f=0,h=[0,0],g=[0,0],l=function(a){var p=c.value;h=[a.clientX,a.clientY];e+=h[0]-g[0]-(h[1]-g[1]);var m=50;a.shiftKey&&(m=5);a.ctrlKey&&(m=500);c.value=Math.min(b.max,
Math.max(b.min,f+e/m*b.step))|0;p!==c.value&&c.dispatchEvent(d);g=[a.clientX,a.clientY]},k=function(a){document.removeEventListener("mousemove",l,!1);document.removeEventListener("mouseup",k,!1);2>Math.abs(e)&&(c.focus(),c.select())};c.addEventListener("mousedown",function(a){a.preventDefault();e=0;f=parseFloat(c.value);g=[a.clientX,a.clientY];document.addEventListener("mousemove",l,!1);document.addEventListener("mouseup",k,!1)},!1);c.addEventListener("change",function(a){a=parseInt(c.value);!1===
...
UI.EllipsisMultilineText.prototype.setValue=function(a){void 0!==a&&(this.content.textContent=a,this.setTitle(a));return this};UI.OverlayPanel=function(){UI.Panel.call(this);this.dom.className="Panel OverlayPanel";return this};UI.OverlayPanel.prototype=Object.create(UI.Panel.prototype);UI.OverlayPanel.prototype.attach=function(a){a=a||document.body;a.appendChild(this.dom);return this};
...
UI.PopupMenu=function(a,b){UI.Panel.call(this);var c=new UI.Icon(a||"bars"),d=(new UI.OverlayPanel).setDisplay("none").attach(this.dom),e=(new UI.Panel).setBorderBottom("1px solid #555").setMarginBottom("10px").setHeight("25px");e.add((new UI.Icon("times")).setFloat("right").setCursor("pointer").onClick(function(){d.setDisplay("none")})).add(new UI.Text(b));d.add(e);c.setTitle("menu");c.setCursor("pointer");c.onClick(function(a){"block"===d.getDisplay()?d.setDisplay("none"):(d.setDisplay("block"),
(new Tether({element:d.dom,target:c.dom,attachment:"top right",targetAttachment:"top left",offset:"0px 5px",constraints:[{to:"scrollParent",attachment:"element",pin:["top","bottom"]}]})).position())});this.add(c);this.setClass("").setDisplay("inline");this.icon=c;this.panel=d;this.entryLabelWidth="100px";return this};UI.PopupMenu.prototype=Object.create(UI.Panel.prototype);
UI.PopupMenu.prototype.addEntry=function(a,b){this.panel.add((new UI.Text(a)).setWidth(this.entryLabelWidth)).add(b||new UI.Panel).add(new UI.Break);return this};UI.PopupMenu.prototype.setEntryLabelWidth=function(a){this.entryLabelWidth=a;return this};UI.PopupMenu.prototype.setMenuDisplay=function(a){this.panel.setDisplay(a);return this};UI.PopupMenu.prototype.setIconTitle=function(a){this.icon.setTitle(a);return this};UI.PopupMenu.prototype.dispose=function(){this.panel.dispose();UI.Element.prototype.dispose.call(this)};
...
UI.ComponentPanel=function(a){UI.Panel.call(this);var b=a.stage,c=a.signals;c.nameChanged.add(function(a){d.setValue(NGL.unicodeHelper(a))});c.visibilityChanged.add(function(a){e.setValue(a)});c.disposed.add(function(){h.dispose()});var d=(new UI.EllipsisText(NGL.unicodeHelper(a.name))).setWidth("100px"),e=(new UI.ToggleIcon(a.visible,"eye","eye-slash")).setTitle("hide/show").setCursor("pointer").setMarginLeft("25px").onClick(function(){a.setVisibility(!a.visible)}),c=(new UI.Icon("bullseye")).setTitle("center").setCursor("pointer").setMarginLeft("10px").onClick(function(){a.centerView(void 0,
!0)}),f=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){b.removeComponent(a)}),h=(new UI.PopupMenu("bars",a.type)).setMarginLeft("46px").setEntryLabelWidth("110px");this.add(d,e,c,f,h);this.menu=h;return this};UI.ComponentPanel.prototype=Object.create(UI.Panel.prototype);UI.ComponentPanel.prototype.addMenuEntry=function(a,b){this.menu.addEntry(a,b);return this};UI.ComponentPanel.prototype.setMenuDisplay=function(a){this.menu.setMenuDisplay(a);return this};NGL.Widget=function(){};
...
NGL.MenubarWidget=function(a){var b=new UI.Panel;b.add(new NGL.MenubarFileWidget(a));b.add(new NGL.MenubarViewWidget(a));b.add(new NGL.MenubarExamplesWidget(a));b.add(new NGL.MenubarHelpWidget(a));return b};
NGL.MenubarFileWidget=function(a){var b="pdb gro cif obj ply ngz gz lzma bz2 zip".split(" "),c=b+["ngl"],d=document.createElement("input");d.type="file";d.multiple=!0;d.style.display="hidden";document.body.appendChild(d);d.accept="."+b.join(",.");d.addEventListener("change",function(b){b=b.target.files;for(var c=b.length,d=0;d<c;++d)a.loadFile(b[d],void 0,void 0,void 0,{asTrajectory:f,firstModelOnly:h,cAlphaOnly:g})},!1);var e=(new NGL.ExportImageWidget(a)).setDisplay("none").attach(),f=!1,h=!1,g=
!1,b=UI.MenubarHelper.createOption,l=UI.MenubarHelper.createInput,k=UI.MenubarHelper.createCheckbox,n=UI.MenubarHelper.createDivider,b=[b("Open...",function(){d.click()}),b("Import...",function(){var b=new NGL.DirectoryListingWidget(a,"Import file",c,function(d){var e=d.path.split(".").pop().toLowerCase();-1!==c.indexOf(e)?a.loadFile(d.path,void 0,void 0,void 0,{asTrajectory:f,firstModelOnly:h,cAlphaOnly:g}):console.log("unknown filetype: "+e);b.dispose()});b.setOpacity("0.8").setLeft("50px").setTop("80px").attach()}),
l("PDB",function(b){13===b.keyCode&&(a.loadFile("rcsb://"+b.target.value,void 0,void 0,void 0,{asTrajectory:f,firstModelOnly:h,cAlphaOnly:g}),b.target.value="")}),k("asTrajectory",!1,function(a){f=a.target.checked}),k("firstModelOnly",!1,function(a){h=a.target.checked}),k("cAlphaOnly",!1,function(a){g=a.target.checked}),n(),b("Screenshot",function(){a.viewer.screenshot({factor:1,type:"image/png",quality:1,antialias:!0,transparent:!1,trim:!1})},"camera"),b("Export image...",function(){e.setOpacity("0.8").setLeft("50px").setTop("80px").setDisplay("block")})],
...
NGL.MenubarHelpWidget=function(a){function b(){d.setOpacity("0.8").setLeft("50px").setTop("80px").setDisplay("block")}var c=(new NGL.PreferencesWidget(a)).setDisplay("none").attach(),d=(new NGL.OverviewWidget).setDisplay("none").attach();NGL.GET("overview")&&b();a=UI.MenubarHelper.createOption;var e=UI.MenubarHelper.createDivider;a=[a("Overview",b),a("Documentation",function(){window.open("../doc/index.html","_blank")}),e(),a("Unittests",function(){window.open("../test/unit/unittests.html","_blank")}),
a("Benchmarks",function(){window.open("../test/bench/benchmarks.html","_blank")}),e(),a("Prefereces",function(){c.setOpacity("0.8").setLeft("50px").setTop("80px").setDisplay("block")},"sliders")];a=UI.MenubarHelper.createOptionsPanel(a);return UI.MenubarHelper.createMenuContainer("Help",a)};
NGL.OverviewWidget=function(){function a(a,b){var c=new UI.Panel,g=(new UI.Icon(a)).setWidth("20px").setFloat("left"),l=(new UI.Text(b)).setDisplay("inline").setMarginLeft("5px");c.setMarginLeft("20px").add(g,l);d.add(c)}var b=new UI.OverlayPanel,c=(new UI.Panel).setBorderBottom("1px solid #555").setHeight("25px"),d=(new UI.Panel).setMarginTop("10px").setMinHeight("100px").setMaxHeight("500px").setMaxWidth("600px").setOverflow("auto");c.add((new UI.Text("NGL Viewer")).setFontStyle("italic"),new UI.Html("&nbsp;&mdash;&nbsp;Overview"));
c.add((new UI.Icon("times")).setCursor("pointer").setMarginLeft("20px").setFloat("right").onClick(function(){b.setDisplay("none")}));b.add(c);b.add(d);d.add((new UI.Panel).add(new UI.Html("To load a new structure use the <i>File</i> menu in the top left via drag'n'drop."))).add(new UI.Break);d.add((new UI.Panel).add(new UI.Text("A number of clickable icons provide common actions. Most icons can be clicked on, just try it or hover the mouse pointer over it to see a tooltip."))).add(new UI.Break);a("eye",
"Controls the visibility of a component.");a("trash-o","Deletes a cmopvponent. Note that a second click is required to confirm the action.");a("bullseye","Centers a component.");a("bars","Opens a menu with further options.");a("square","Opens a menu with coloring options.");a("filter","Indicates an atom-selection input fields.");d.add(new UI.Text("Mouse controls")).add(new UI.Html("<ul><li>Left button hold and move to rotate camera around center.</li><li>Left button click to pick atom.</li><li>Middle button hold and move to zoom camera in and out.</li><li>Middle button click to center camera on atom.</li><li>Right button hold and move to translate camera in the screen plane.</li></ul>"));
d.add((new UI.Panel).add(new UI.Html("For more information please visit the <a href='../doc/index.html' target='_blank'>documentation pages</a>.")));return b};
...
d.add(a);d.add(e);var f=(new UI.Select).setOptions({dark:"dark",light:"light"}).setValue(c.getKey("theme")).onChange(function(){c.setTheme(f.getValue())}),h=(new UI.Select).setOptions({low:"low",medium:"medium",high:"high"}).setValue(c.getKey("quality")).onChange(function(){c.setQuality(h.getValue())}),g=(new UI.Checkbox).setValue(c.getKey("impostor")).onChange(function(){c.setImpostor(g.getValue())});b("theme",f);b("quality",h);b("impostor",g);return d};
...
c.add(e);var f=(new UI.Select).setOptions({1:"1x",2:"2x",3:"3x",4:"4x",5:"5x",6:"6x",7:"7x",8:"8x",9:"9x",10:"10x"}).setValue("4");(new UI.Select).setOptions({"image/png":"PNG","image/jpeg":"JPEG"}).setValue("image/png");(new UI.Select).setOptions({"0.1":"0.1","0.2":"0.2","0.3":"0.3","0.4":"0.4","0.5":"0.5","0.6":"0.6","0.7":"0.7","0.8":"0.8","0.9":"0.9","1.0":"1.0"}).setValue("1.0");var h=(new UI.Checkbox).setValue(!0),g=(new UI.Checkbox).setValue(!1),l=(new UI.Checkbox).setValue(!1),k=(new UI.Progress).setDisplay("none"),
n=(new UI.Button("export")).onClick(function(){n.setDisplay("none");k.setDisplay("inline-block");setTimeout(function(){a.exportImage(parseInt(f.getValue()),h.getValue(),g.getValue(),l.getValue(),function(a,b,c){1===a&&k.setMax(b);a>=b?k.setIndeterminate():k.setValue(a);c&&(k.setDisplay("none"),n.setDisplay("inline-block"))})},50)});b("scale",f);b("antialias",h);b("transparent",g);b("trim",l);e.add(new UI.Break,n,k);return c};
...
b);return}d.add(c);e.push(b);f.push(c)});b.componentRemoved.add(function(a){a=e.indexOf(a);-1!==a&&(f[a].dispose(),e.splice(a,1),f.splice(a,1))});var b=(new UI.Icon("plus-square")).setTitle("expand all").setCursor("pointer").onClick(function(){f.forEach(function(a){a.expand()})}),h=(new UI.Icon("minus-square")).setTitle("collapse all").setCursor("pointer").setMarginLeft("10px").onClick(function(){f.forEach(function(a){a.collapse()})}),g=(new UI.Icon("bullseye")).setTitle("center all").setCursor("pointer").setMarginLeft("10px").onClick(function(){a.centerView()}),
l=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){a.removeAllComponents()}),k=(new UI.PopupMenu("cogs","Settings")).setIconTitle("settings").setMarginLeft("10px"),n=(new UI.Range(1,100,a.viewer.params.clipNear,1)).onInput(function(){a.viewer.setClip(n.getValue(),p.getValue())}),p=(new UI.Range(1,100,a.viewer.params.clipFar,1)).onInput(function(){a.viewer.setClip(n.getValue(),p.getValue())}),m=(new UI.Range(1,100,a.viewer.params.clipDist,1)).onInput(function(){a.viewer.params.clipDist=
m.getValue();a.viewer.requestRender()}),q=(new UI.Range(1,100,a.viewer.params.fogNear,1)).onInput(function(){a.viewer.setFog(null,null,q.getValue(),r.getValue())}),r=(new UI.Range(1,100,a.viewer.params.fogFar,1)).onInput(function(){a.viewer.setFog(null,null,q.getValue(),r.getValue())});k.addEntry("clip near",n).addEntry("clip far",p).addEntry("clip distance",m).addEntry("fog near",q).addEntry("fog far",r);b=(new UI.Panel).setClass("Panel Sticky").add(b,h,g,l,k);c.add(b,d);return c};
...
NGL.StructureComponentWidget=function(a,b){function c(){var c={"":"[ structure ]"};b.eachComponent(function(b,d){b!==a&&(c[d]=NGL.unicodeHelper(b.name))},NGL.StructureComponent);k.setOptions(c)}var d=a.signals,e=new UI.CollapsibleIconPanel("file"),f=new UI.Panel,h=new UI.Panel;d.requestGuiVisibility.add(function(a){e.setCollapsed(!a)});d.representationAdded.add(function(a){f.add(new NGL.RepresentationComponentWidget(a,b))});d.trajectoryAdded.add(function(a){h.add(new NGL.TrajectoryComponentWidget(a,
b))});e.add((new UI.SelectionPanel(a.selection)).setMarginLeft("20px").setInputWidth("214px"));var d=(new UI.Button("export")).onClick(function(){var b=new Blob([a.structure.toPdb()],{type:"text/plain"});NGL.download(b,"structure.pdb");m.setMenuDisplay("none")}),g=(new UI.Select).setColor("#444").setOptions(function(){var a={"":"[ add ]"},b;for(b in NGL.representationTypes)a[b]=b;return a}()).onChange(function(){a.addRepresentation(g.getValue());g.setValue("");m.setMenuDisplay("none")}),l=(new UI.Button("import")).onClick(function(){m.setMenuDisplay("none");
...
k.setValue("");m.setMenuDisplay("none")});c();var n=(new UI.Button("calculate")).onClick(function(){a.structure.autoSS();a.rebuildRepresentations();m.setMenuDisplay("none")}),p=(new UI.Button("duplicate")).onClick(function(){b.addComponent(new NGL.StructureComponent(b,a.structure.clone(),{}));m.setMenuDisplay("none")}),m=(new UI.ComponentPanel(a)).setDisplay("inline-block").setMargin("0px").addMenuEntry("PDB file",d).addMenuEntry("Representation",g).addMenuEntry("Trajectory",l).addMenuEntry("Superpose",
k).addMenuEntry("SS",n).addMenuEntry("Structure",p).addMenuEntry("File",(new UI.Text(a.structure.path)).setMaxWidth("100px").setWordWrap("break-word"));e.addStatic(m).add(h).add(f);return e};
NGL.SurfaceComponentWidget=function(a,b){var c=a.signals,d=new UI.CollapsibleIconPanel("file"),e=new UI.Panel;c.requestGuiVisibility.add(function(a){d.setCollapsed(!a)});c.representationAdded.add(function(a){e.add(new NGL.RepresentationComponentWidget(a,b))});var c=(new UI.Button("add")).onClick(function(){a.addRepresentation();f.setMenuDisplay("none")}),f=(new UI.ComponentPanel(a)).setDisplay("inline-block").setMargin("0px").addMenuEntry("Representation",c).addMenuEntry("File",(new UI.Text(a.surface.path)).setMaxWidth("100px").setWordWrap("break-word"));
d.addStatic(f).add(e);return d};
NGL.ScriptComponentWidget=function(a,b){var c=a.signals,d=new UI.CollapsibleIconPanel("file"),e=(new UI.Panel).setMarginLeft("20px");c.requestGuiVisibility.add(function(a){d.setCollapsed(!a)});c.nameChanged.add(function(a){h.setValue(NGL.unicodeHelper(a))});c.statusChanged.add(function(a){"finished"===a&&(d.removeStatic(g),d.addStatic(f))});a.script.signals.elementAdded.add(function(a){e.add.apply(e,a)});var f=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){b.removeComponent(a)}),h=
(new UI.EllipsisText(NGL.unicodeHelper(a.name))).setWidth("100px"),g=(new UI.Icon("spinner")).addClass("spin").setMarginLeft("25px");d.addStatic(h).addStatic(g);d.add(e);return d};
NGL.RepresentationComponentWidget=function(a,b){var c=a.signals,d=(new UI.CollapsibleIconPanel("bookmark")).setMarginLeft("20px");c.visibilityChanged.add(function(a){f.setValue(a)});c.colorChanged.add(function(a){g.setValue(a)});c.disposed.add(function(){l.dispose();g.dispose();d.dispose()});var e=(new UI.EllipsisText(a.repr.type)).setWidth("80px"),f=(new UI.ToggleIcon(a.visible,"eye","eye-slash")).setTitle("hide/show").setCursor("pointer").setMarginLeft("25px").onClick(function(){a.setVisibility(!a.visible)}),
h=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){a.dispose()}),g=(new UI.ColorPopupMenu).setMarginLeft("10px").setValue(a.repr.color).onChange(function(){var b=new THREE.Color;return function(c){c=g.getScheme();"color"===c?(b.setStyle(g.getColor()),a.setColor(b.getHex())):a.setColor(c);a.viewer.requestRender()}}());d.addStatic(e).addStatic(f).addStatic(h).addStatic(g);(a.parent instanceof NGL.StructureComponent||a.parent instanceof NGL.TrajectoryComponent)&&d.add((new UI.SelectionPanel(a.repr.selection)).setMarginLeft("20px").setInputWidth("194px"));
var l=(new UI.PopupMenu("bars","Representation")).setMarginLeft("45px").setEntryLabelWidth("110px");Object.keys(a.repr.parameters).forEach(function(b){var d=a.repr,e,f=d.parameters[b];f&&("number"===f.type||"integer"===f.type?(e="number"===f.type?(new UI.Number(parseFloat(d[b])||NaN)).setPrecision(f.precision):new UI.Integer(parseInt(d[b])||NaN),e.setRange(f.min,f.max)):"boolean"===f.type?e=new UI.Checkbox(d[b]):"text"===f.type?e=new UI.Input(d[b]):"select"===f.type?e=(new UI.Select).setWidth("").setOptions(f.options).setValue(d[b]):
"button"===f.type&&(e=(new UI.Button(b)).onClick(function(){d[b]()})),e&&(c.parametersChanged.add(function(a){e.setValue(a[b])}),e.onChange(function(){var a={};a[b]=e.getValue();d.setParameters(a);d.viewer.render()}),l.addEntry(b,e)))});d.addStatic(l);return d};
NGL.TrajectoryComponentWidget=function(a,b){function c(a){g.clear().add(k.setWidth("70px"));k.setRange(-1,a-1);p.setRange(-1,a-1);n.setValue(Math.ceil((a+1)/100));q.step=n.getValue();q.end=a}var d=a.signals,e=a.trajectory,f=(new UI.CollapsibleIconPanel("database")).setMarginLeft("20px"),h=new UI.Panel;d.representationAdded.add(function(a){h.add(new NGL.RepresentationComponentWidget(a,b))});d.disposed.add(function(){u.dispose();f.dispose()});var g=(new UI.Panel).setMarginLeft("10px").setDisplay("inline").add((new UI.Icon("spinner")).addClass("spin").setMarginRight("69px"));
d.gotNumframes.add(c);d.frameChanged.add(function(a){k.setValue(a);p.setValue(a);g.clear().add(k.setWidth("70px"))});var l=(new UI.EllipsisText(e.name)).setWidth("108px");f.addStatic(l);f.addStatic(g);var k=(new UI.Integer(-1)).setMarginLeft("5px").setWidth("70px").setRange(-1,-1).onChange(function(a){e.setFrame(k.getValue());u.setMenuDisplay("none")}),n=(new UI.Integer(1)).setWidth("30px").setRange(1,1E4).onChange(function(){q.step=n.getValue()}),l=new UI.Panel,p=(new UI.Range(-1,-1,-1,1)).setWidth("197px").setMargin("0px").setPadding("0px").setBorder("0px").onInput(function(a){a=
p.getValue();a!==e.currentFrame&&(e.player&&e.player._running?(e.setPlayer(),e.setFrame(a)):e.inProgress||e.setFrame(a))}),m=(new UI.Integer(50)).setWidth("30px").setRange(10,1E3).onChange(function(){q.timeout=m.getValue()}),q=new NGL.TrajectoryPlayer(e,n.getValue(),m.getValue(),0,e.numframes),r=(new UI.ToggleIcon(!0,"play","pause")).setMarginRight("10px").setMarginLeft("20px").setWidth("12px").setTitle("play").onClick(function(){q.toggle()});q.signals.startedRunning.add(function(){r.setTitle("pause").setValue(!1)});
q.signals.haltedRunning.add(function(){r.setTitle("play").setValue(!0)});l.add(r);l.add(p);f.add((new UI.SelectionPanel(e.selection)).setMarginLeft("20px").setInputWidth("194px"));var s=(new UI.Checkbox(e.params.centerPbc)).onChange(function(){a.setParameters({centerPbc:s.getValue()})}),t=(new UI.Checkbox(e.params.removePbc)).onChange(function(){a.setParameters({removePbc:t.getValue()})}),v=(new UI.Checkbox(e.params.superpose)).onChange(function(){a.setParameters({superpose:v.getValue()})});d.parametersChanged.add(function(a){s.setValue(a.centerPbc);
t.setValue(a.removePbc);v.setValue(a.superpose)});(new UI.Button("download")).onClick(function(){e.download(n.getValue())});var d=(new UI.Button("add")).onClick(function(){a.addRepresentation()}),w=(new UI.DisposeIcon).setDisposeFunction(function(){a.parent.removeTrajectory(a)});e.numframes&&c(e.numframes);var u=(new UI.PopupMenu("bars","Trajectory")).setMarginLeft("10px").setEntryLabelWidth("110px").addEntry("Path",d).addEntry("Center",s).addEntry("Remove PBC",t).addEntry("Superpose",v).addEntry("Step",
n).addEntry("Timeout",m).addEntry("File",(new UI.Text(e.trajPath)).setMaxWidth("100px").setWordWrap("break-word")).addEntry("Dispose",w);f.addStatic(u);f.add(l);f.add(h);return f};NGL.lastUsedDirectory="";NGL.DirectoryListing=function(){this.signals={listingLoaded:new signals.Signal}};
