...
NGL.ExportImageWidget=function(a){function b(a,b){f.add((new UI.Text(a)).setWidth("80px")).add(b||new UI.Panel).add(new UI.Break)}function c(b,c,d,e,f,g){var l=[];a.eachRepresentation(function(a){l.push(a.getParameters());var b=a.getParameters();void 0!==b.subdiv&&(b.subdiv=Math.max(25,b.subdiv));void 0!==b.radialSegments&&(b.radialSegments=Math.max(25,b.radialSegments));b.quality=null;a.rebuild(b)},NGL.StructureComponent);a.viewer.screenshot({factor:b,type:c,quality:d,antialias:e,transparent:f,trim:g,
onProgress:function(b,c,d){1===b&&m.setMax(c);b>=c?m.setIndeterminate():m.setValue(b);if(d){m.setDisplay("none");q.setDisplay("inline-block");var e=0;a.eachRepresentation(function(a){a.rebuild(l[e]);e+=1},NGL.StructureComponent)}}})}var d=new UI.OverlayPanel,e=(new UI.Panel).setBorderBottom("1px solid #555").setHeight("25px"),f=(new UI.Panel).setMarginTop("10px").setMinHeight("100px").setMaxHeight("500px").setOverflow("auto");e.add(new UI.Text("Image export"));e.add((new UI.Icon("times")).setMarginLeft("20px").setFloat("right").onClick(function(){d.setDisplay("none")}));
