...
UI.Number=function(a){UI.Element.call(this);var b=this,c=document.createElement("input");c.className="Number";c.value="0.00";c.addEventListener("keydown",function(a){a.stopPropagation();13===a.keyCode&&c.blur()},!1);this.min=-Infinity;this.max=Infinity;this.precision=2;this.step=1;this.dom=c;this.setValue(a);var d=document.createEvent("HTMLEvents");d.initEvent("change",!0,!0);var e=0,f=0,g=new THREE.Vector2,h=new THREE.Vector2,k=function(a){var k=c.value;g.set(a.clientX,a.clientY);e+=g.x-h.x-(g.y-
h.y);var m=50;a.shiftKey&&(m=5);a.ctrlKey&&(m=500);c.value=Math.min(b.max,Math.max(b.min,f+e/m*b.step)).toFixed(b.precision);k!==c.value&&c.dispatchEvent(d);h.set(a.clientX,a.clientY)},l=function(a){document.removeEventListener("mousemove",k,!1);document.removeEventListener("mouseup",l,!1);2>Math.abs(e)&&(c.focus(),c.select())};c.addEventListener("mousedown",function(a){a.preventDefault();e=0;f=parseFloat(c.value);h.set(a.clientX,a.clientY);document.addEventListener("mousemove",k,!1);document.addEventListener("mouseup",
l,!1)},!1);c.addEventListener("change",function(a){a=parseFloat(c.value);c.value=!1===isNaN(a)?a:0},!1);c.addEventListener("focus",function(a){c.style.backgroundColor="";c.style.borderColor="#ccc";c.style.cursor=""},!1);c.addEventListener("blur",function(a){c.style.backgroundColor="transparent";c.style.borderColor="transparent";c.style.cursor="col-resize"},!1);return this};UI.Number.prototype=Object.create(UI.Element.prototype);UI.Number.prototype.getValue=function(){return parseFloat(this.dom.value)};
...
UI.Integer=function(a){UI.Element.call(this);var b=this,c=document.createElement("input");c.className="Number";c.value="0.00";c.addEventListener("keydown",function(a){a.stopPropagation()},!1);this.min=-Infinity;this.max=Infinity;this.step=1;this.dom=c;this.setValue(a);var d=document.createEvent("HTMLEvents");d.initEvent("change",!0,!0);var e=0,f=0,g=new THREE.Vector2,h=new THREE.Vector2,k=function(a){var k=c.value;g.set(a.clientX,a.clientY);e+=g.x-h.x-(g.y-h.y);var m=50;a.shiftKey&&(m=5);a.ctrlKey&&
(m=500);c.value=Math.min(b.max,Math.max(b.min,f+e/m*b.step))|0;k!==c.value&&c.dispatchEvent(d);h.set(a.clientX,a.clientY)},l=function(a){document.removeEventListener("mousemove",k,!1);document.removeEventListener("mouseup",l,!1);2>Math.abs(e)&&(c.focus(),c.select())};c.addEventListener("mousedown",function(a){a.preventDefault();e=0;f=parseFloat(c.value);h.set(a.clientX,a.clientY);document.addEventListener("mousemove",k,!1);document.addEventListener("mouseup",l,!1)},!1);c.addEventListener("change",
...
UI.DisposeIcon=function(){UI.Icon.call(this,"trash-o");var a=!1,b=this;this.setTitle("delete");this.onClick(function(){!0===a?"function"===typeof b.disposeFunction&&b.disposeFunction():(b.setColor("rgb(178, 34, 34)"),b.dom.classList.add("deleteInfo"),a=!0,setTimeout(function(){b.setColor("#888");b.dom.classList.remove("deleteInfo");a=!1},1500))});return this};UI.DisposeIcon.prototype=Object.create(UI.Icon.prototype);UI.DisposeIcon.prototype.setDisposeFunction=function(a){this.disposeFunction=a;return this};
...
!1,b=UI.MenubarHelper.createOption,k=UI.MenubarHelper.createInput,l=UI.MenubarHelper.createCheckbox,n=UI.MenubarHelper.createDivider,b=[b("Open...",function(){d.click()}),b("Import...",function(){var b=new NGL.DirectoryListingWidget(a,"Import file",c,function(d){var e=d.path.split(".").pop().toLowerCase();-1!==c.indexOf(e)?a.loadFile(d.path,void 0,void 0,void 0,{asTrajectory:f,firstModelOnly:g,cAlphaOnly:h}):console.log("unknown filetype: "+e);b.dispose()});b.setOpacity("0.8").setLeft("50px").setTop("80px").attach()}),
k("PDB",function(b){13===b.keyCode&&(a.loadFile("rcsb://"+b.target.value,void 0,void 0,void 0,{asTrajectory:f,firstModelOnly:g,cAlphaOnly:h}),b.target.value="")}),l("asTrajectory",!1,function(a){f=a.target.checked}),l("firstModelOnly",!1,function(a){g=a.target.checked}),l("cAlphaOnly",!1,function(a){h=a.target.checked}),n(),b("Screenshot",function(){a.viewer.screenshot({factor:1,type:"image/png",quality:1,antialias:!0,transparent:!1,trim:!1})},"camera"),b("Export image...",function(){e.setOpacity("0.8").setLeft("50px").setTop("80px").setDisplay("block")})],
...
NGL.ExportImageWidget=function(a){function b(a,b){f.add((new UI.Text(a)).setWidth("80px")).add(b||new UI.Panel).add(new UI.Break)}function c(b,c,d,e,f,g){var k=[];a.eachRepresentation(function(a){k.push(a.getParameters());var b=a.getParameters();void 0!==b.subdiv&&(b.subdiv=Math.max(25,b.subdiv));void 0!==b.radialSegments&&(b.radialSegments=Math.max(25,b.radialSegments));b.quality=null;a.rebuild(b)},NGL.StructureComponent);a.viewer.screenshot({factor:b,type:c,quality:d,antialias:e,transparent:f,trim:g,
onProgress:function(b,c,d){1===b&&m.setMax(c);b>=c?m.setIndeterminate():m.setValue(b);if(d){m.setDisplay("none");p.setDisplay("inline-block");var e=0;a.eachRepresentation(function(a){a.rebuild(k[e]);e+=1},NGL.StructureComponent)}}})}var d=new UI.OverlayPanel,e=(new UI.Panel).setBorderBottom("1px solid #555").setHeight("25px"),f=(new UI.Panel).setMarginTop("10px").setMinHeight("100px").setMaxHeight("500px").setOverflow("auto");e.add(new UI.Text("Image export"));e.add((new UI.Icon("times")).setMarginLeft("20px").setFloat("right").onClick(function(){d.setDisplay("none")}));
d.add(e);d.add(f);var g=(new UI.Select).setOptions({1:"1x",2:"2x",3:"3x",4:"4x",5:"5x",6:"6x",7:"7x",8:"8x",9:"9x",10:"10x"}).setValue("4"),h=(new UI.Select).setOptions({"image/png":"PNG","image/jpeg":"JPEG"}).setValue("image/png"),k=(new UI.Select).setOptions({"0.1":"0.1","0.2":"0.2","0.3":"0.3","0.4":"0.4","0.5":"0.5","0.6":"0.6","0.7":"0.7","0.8":"0.8","0.9":"0.9","1.0":"1.0"}).setValue("1.0"),l=(new UI.Checkbox).setValue(!0),n=(new UI.Checkbox).setValue(!1),q=(new UI.Checkbox).setValue(!1),m=
(new UI.Progress).setDisplay("none"),p=(new UI.Button("export")).onClick(function(){p.setDisplay("none");m.setDisplay("inline-block");setTimeout(function(){c(parseInt(g.getValue()),h.getValue(),parseFloat(k.getValue()),l.getValue(),n.getValue(),q.getValue())},50)});b("scale",g);b("antialias",l);b("transparent",n);b("trim",q);f.add(new UI.Break,p,m);return d};
...
b);return}d.add(c);e.push(b);f.push(c)});b.componentRemoved.add(function(a){a=e.indexOf(a);-1!==a&&(f[a].dispose(),e.splice(a,1),f.splice(a,1))});var b=(new UI.Icon("plus-square")).setTitle("expand all").onClick(function(){f.forEach(function(a){a.expand()})}),g=(new UI.Icon("minus-square")).setTitle("collapse all").setMarginLeft("10px").onClick(function(){f.forEach(function(a){a.collapse()})}),h=(new UI.Icon("bullseye")).setTitle("center all").setMarginLeft("10px").onClick(function(){a.centerView()}),
k=(new UI.PopupMenu("cogs","Settings")).setIconTitle("settings").setMarginLeft("10px"),l=(new UI.Range(1,100,a.viewer.params.clipNear,1)).onInput(function(){a.viewer.setClip(l.getValue(),n.getValue())}),n=(new UI.Range(1,100,a.viewer.params.clipFar,1)).onInput(function(){a.viewer.setClip(l.getValue(),n.getValue())}),q=(new UI.Range(1,100,a.viewer.params.clipDist,1)).onInput(function(){a.viewer.params.clipDist=q.getValue();a.viewer.requestRender()}),m=(new UI.Range(1,100,a.viewer.params.fogNear,1)).onInput(function(){a.viewer.setFog(null,
null,m.getValue(),p.getValue())}),p=(new UI.Range(1,100,a.viewer.params.fogFar,1)).onInput(function(){a.viewer.setFog(null,null,m.getValue(),p.getValue())});k.addEntry("clip near",l).addEntry("clip far",n).addEntry("clip distance",q).addEntry("fog near",m).addEntry("fog far",p);b=(new UI.Panel).setClass("Panel Sticky").add(b,g,h,k);c.add(b,d);return c};
NGL.ComponentWidget=function(a,b){var c=a.signals,d=(new UI.CollapsibleIconPanel("file")).setTitle("expand/collapse");c.requestGuiVisibility.add(function(a){d.setCollapsed(!a)});c.statusChanged.add(function(b){b={404:"Error: file not found"}[a.status]||a.status;d.setCollapsed(!1);d.add((new UI.Text(b)).setMarginLeft("20px").setWidth("200px").setWordWrap("break-word"));d.removeStatic(e);d.addStatic(f)});var c=(new UI.Text(NGL.unicodeHelper(a.name))).setWidth("100px").setWordWrap("break-word"),e=(new UI.Panel).setDisplay("inline").add((new UI.Icon("spinner")).addClass("spin").setMarginLeft("25px")),
f=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){b.removeComponent(a)});d.addStatic(c,e);return d};
NGL.StructureComponentWidget=function(a,b){function c(){var c={"":"[ structure ]"};b.eachComponent(function(b,d){b!==a&&(c[d]=NGL.unicodeHelper(b.name))},NGL.StructureComponent);l.setOptions(c)}var d=a.signals,e=(new UI.CollapsibleIconPanel("file")).setTitle("expand/collapse"),f=new UI.Panel,g=new UI.Panel;d.requestGuiVisibility.add(function(a){e.setCollapsed(!a)});d.representationAdded.add(function(a){f.add(new NGL.RepresentationComponentWidget(a,b))});d.trajectoryAdded.add(function(a){g.add(new NGL.TrajectoryComponentWidget(a,
b))});e.add((new UI.SelectionPanel(a.selection)).setMarginLeft("20px").setInputWidth("214px"));var d=(new UI.Button("export")).onClick(function(){var b=new Blob([a.structure.toPdb()],{type:"text/plain"});NGL.download(b,"structure.pdb");m.setMenuDisplay("none")}),h=(new UI.Select).setColor("#444").setOptions(function(){var a={"":"[ add ]"},b;for(b in NGL.representationTypes)a[b]=b;return a}()).onChange(function(){a.addRepresentation(h.getValue());h.setValue("");m.setMenuDisplay("none")}),k=(new UI.Button("import")).onClick(function(){m.setMenuDisplay("none");
var c=["xtc","trr","dcd","netcdf","nc"],d=new NGL.DirectoryListingWidget(b,"Import trajectory",c,function(b){var e=b.path.split(".").pop().toLowerCase();-1!==c.indexOf(e)?(console.log(b),a.addTrajectory(b.path),d.dispose()):console.log("unknown trajectory type: "+e)});d.setOpacity("0.8").setLeft("50px").setTop("80px").attach()});b.signals.componentAdded.add(c);b.signals.componentRemoved.add(c);var l=(new UI.Select).setColor("#444").onChange(function(){a.superpose(b.compList[l.getValue()],!0);a.centerView();
l.setValue("");m.setMenuDisplay("none")});c();var n=(new UI.Button("calculate")).onClick(function(){a.structure.autoSS();a.rebuildRepresentations();m.setMenuDisplay("none")}),q=(new UI.Button("duplicate")).onClick(function(){b.addComponent(new NGL.StructureComponent(b,a.structure.clone(),{}));m.setMenuDisplay("none")}),m=(new UI.ComponentPanel(a)).setDisplay("inline-block").setMargin("0px").addMenuEntry("PDB file",d).addMenuEntry("Representation",h).addMenuEntry("Trajectory",k).addMenuEntry("Superpose",
l).addMenuEntry("SS",n).addMenuEntry("Structure",q).addMenuEntry("File",(new UI.Text(a.structure.path)).setMaxWidth("100px").setWordWrap("break-word"));e.addStatic(m).add(g).add(f);return e};
NGL.SurfaceComponentWidget=function(a,b){var c=a.signals,d=(new UI.CollapsibleIconPanel("file")).setTitle("expand/collapse"),e=new UI.Panel;c.requestGuiVisibility.add(function(a){d.setCollapsed(!a)});c.representationAdded.add(function(a){e.add(new NGL.RepresentationComponentWidget(a,b))});var c=(new UI.Button("add")).onClick(function(){a.addRepresentation();f.setMenuDisplay("none")}),f=(new UI.ComponentPanel(a)).setDisplay("inline-block").setMargin("0px").addMenuEntry("Representation",c).addMenuEntry("File",
(new UI.Text(a.surface.path)).setMaxWidth("100px").setWordWrap("break-word"));d.addStatic(f).add(e);return d};
NGL.ScriptComponentWidget=function(a,b){var c=a.signals,d=(new UI.CollapsibleIconPanel("file")).setTitle("expand/collapse"),e=(new UI.Panel).setMarginLeft("20px");c.requestGuiVisibility.add(function(a){d.setCollapsed(!a)});c.nameChanged.add(function(a){g.setValue(NGL.unicodeHelper(a))});c.statusChanged.add(function(a){"finished"===a&&(d.removeStatic(h),d.addStatic(f))});a.script.signals.elementAdded.add(function(a){e.add.apply(e,a)});var f=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){b.removeComponent(a)}),
g=(new UI.Text(NGL.unicodeHelper(a.name))).setWidth("100px").setWordWrap("break-word"),h=(new UI.Icon("spinner")).addClass("spin").setMarginLeft("25px");d.addStatic(g).addStatic(h);d.add(e);return d};
NGL.RepresentationComponentWidget=function(a,b){var c=a.signals,d=(new UI.CollapsibleIconPanel("bookmark")).setTitle("expand/collapse").setMarginLeft("20px");c.visibilityChanged.add(function(a){e.setValue(a)});c.colorChanged.add(function(a){g.setValue(a)});c.disposed.add(function(){h.dispose();g.dispose();d.dispose()});var e=(new UI.ToggleIcon(a.visible,"eye","eye-slash")).setTitle("hide/show").setMarginLeft("25px").onClick(function(){a.setVisibility(!a.visible)}),f=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){a.dispose()}),
...
NGL.TrajectoryComponentWidget=function(a,b){function c(a){h.clear().add(l.setWidth("70px"));l.setRange(-1,a-1);q.setRange(-1,a-1);n.setValue(Math.ceil((a+1)/100));p.step=n.getValue();p.end=a}var d=a.signals,e=a.trajectory,f=(new UI.CollapsibleIconPanel("database")).setTitle("expand/collapse").setMarginLeft("20px"),g=new UI.Panel;d.representationAdded.add(function(a){g.add(new NGL.RepresentationComponentWidget(a,b))});d.disposed.add(function(){v.dispose();f.dispose()});var h=(new UI.Panel).setMarginLeft("10px").setDisplay("inline").add((new UI.Icon("spinner")).addClass("spin").setMarginRight("69px"));
d.gotNumframes.add(c);d.frameChanged.add(function(a){l.setValue(a);q.setValue(a);h.clear().add(l.setWidth("70px"))});var k=(new UI.Text(e.name)).setWidth("108px").setWordWrap("break-word");f.addStatic(k);f.addStatic(h);var l=(new UI.Integer(-1)).setMarginLeft("5px").setWidth("70px").setRange(-1,-1).onChange(function(a){e.setFrame(l.getValue());v.setMenuDisplay("none")}),n=(new UI.Integer(1)).setWidth("30px").setRange(1,1E4).onChange(function(){p.step=n.getValue()}),k=new UI.Panel,q=(new UI.Range(-1,
-1,-1,1)).setWidth("197px").setMargin("0px").setPadding("0px").setBorder("0px").onInput(function(a){a=q.getValue();a!==e.currentFrame&&(e.player&&e.player._running?(e.setPlayer(),e.setFrame(a)):e.inProgress||e.setFrame(a))}),m=(new UI.Integer(50)).setWidth("30px").setRange(10,1E3).onChange(function(){p.timeout=m.getValue()}),p=new NGL.TrajectoryPlayer(e,n.getValue(),m.getValue(),0,e.numframes),r=(new UI.ToggleIcon(!0,"play","pause")).setMarginRight("10px").setMarginLeft("20px").setWidth("12px").setTitle("play").onClick(function(){p.toggle()});
p.signals.startedRunning.add(function(){r.setTitle("pause").setValue(!1)});p.signals.haltedRunning.add(function(){r.setTitle("play").setValue(!0)});k.add(r);k.add(q);f.add((new UI.SelectionPanel(e.selection)).setMarginLeft("20px").setInputWidth("194px"));var s=(new UI.Checkbox(e.params.centerPbc)).onChange(function(){a.setParameters({centerPbc:s.getValue()})}),t=(new UI.Checkbox(e.params.removePbc)).onChange(function(){a.setParameters({removePbc:t.getValue()})}),u=(new UI.Checkbox(e.params.superpose)).onChange(function(){a.setParameters({superpose:u.getValue()})});
d.parametersChanged.add(function(a){s.setValue(a.centerPbc);t.setValue(a.removePbc);u.setValue(a.superpose)});(new UI.Button("download")).onClick(function(){e.download(n.getValue())});var d=(new UI.Button("add")).onClick(function(){a.addRepresentation()}),w=(new UI.DisposeIcon).setDisposeFunction(function(){a.parent.removeTrajectory(a)});e.numframes&&c(e.numframes);var v=(new UI.PopupMenu("bars","Trajectory")).setMarginLeft("10px").setEntryLabelWidth("110px").addEntry("Path",d).addEntry("Center",
s).addEntry("Remove PBC",t).addEntry("Superpose",u).addEntry("Step",n).addEntry("Timeout",m).addEntry("File",(new UI.Text(e.trajPath)).setMaxWidth("100px").setWordWrap("break-word")).addEntry("Dispose",w);f.addStatic(v);f.add(k);f.add(g);return f};NGL.lastUsedDirectory="";NGL.DirectoryListing=function(){this.signals={listingLoaded:new signals.Signal}};
...
NGL.DirectoryListingWidget=function(a,b,c,d){function e(a,b,c,d,e){return(b=Math,c=b.log,d=1E3,e=c(a)/c(d)|0,a/b.pow(d,e)).toFixed(2)+String.fromCharCode(160)+(e?"kMGTPEZY"[--e]+"B":"Bytes")}var f=new NGL.DirectoryListing;f.getListing(NGL.lastUsedDirectory);a=f.signals;var g=new UI.OverlayPanel,h=(new UI.Panel).setBorderBottom("1px solid #555").setHeight("30px"),k=(new UI.Panel).setMarginTop("10px").setMinHeight("100px").setMaxHeight("500px").setOverflow("auto"),l=(new UI.Select).setColor("#444").setMarginLeft("20px").setWidth("").setMaxWidth("200px").setOptions(f.getFolderDict()).onChange(function(){f.getListing(l.getValue())});
h.add(new UI.Text(b||"Directoy listing"));h.add(l);h.add((new UI.Icon("times")).setMarginLeft("20px").setFloat("right").onClick(function(){g.dispose()}));g.add(h);g.add(k);a.listingLoaded.add(function(a,b){NGL.lastUsedDirectory=a;k.clear();l.setOptions(f.getFolderDict(a)).setValue(a);b.forEach(function(a){var b=a.path.split(".").pop().toLowerCase();if(!c||a.dir||-1!==c.indexOf(b)){var g;a.dir?(b="folder-o",g=a.name):(b="file-o",g=a.name+String.fromCharCode(160)+"("+e(a.size)+")");b=(new UI.Panel).setDisplay("block").add((new UI.Icon(b)).setWidth("20px")).add(new UI.Text(g)).onClick(function(){a.dir?
f.getListing(a.path):d(a)});a.restricted&&b.add((new UI.Icon("lock")).setMarginLeft("5px"));k.add(b)}})});return g};
