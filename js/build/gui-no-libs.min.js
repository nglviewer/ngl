...
UI.Integer=function(a){UI.Element.call(this);var b=this,c=document.createElement("input");c.className="Number";c.value="0.00";c.addEventListener("keydown",function(a){a.stopPropagation()},!1);this.min=-Infinity;this.max=Infinity;this.step=1;this.dom=c;this.setValue(a);var d=document.createEvent("HTMLEvents");d.initEvent("change",!0,!0);var e=0,f=0,g=[0,0],h=[0,0],k=function(a){var l=c.value;g=[a.clientX,a.clientY];e+=g[0]-h[0]-(g[1]-h[1]);var q=50;a.shiftKey&&(q=5);a.ctrlKey&&(q=500);c.value=Math.min(b.max,
Math.max(b.min,f+e/q*b.step))|0;l!==c.value&&c.dispatchEvent(d);h=[a.clientX,a.clientY]},l=function(a){document.removeEventListener("mousemove",k,!1);document.removeEventListener("mouseup",l,!1);2>Math.abs(e)&&(c.focus(),c.select())};c.addEventListener("mousedown",function(a){a.preventDefault();e=0;f=parseFloat(c.value);h=[a.clientX,a.clientY];document.addEventListener("mousemove",k,!1);document.addEventListener("mouseup",l,!1)},!1);c.addEventListener("change",function(a){a=parseInt(c.value);!1===
...
UI.VirtualList=function(a,b,c,d){function e(a){var c=d(a);c.classList.add("VirtualListRow");c.style.height=b+"px";c.style.top=a*b+"px";return c}function f(a){var b=Math.min(h,a+l);t(a,b);for(var c=document.createDocumentFragment();a<b;a++)c.appendChild(e(a));b=1;for(a=n.childNodes.length;b<a;b++)n.childNodes[b].style.display="none",n.childNodes[b].setAttribute("data-rm","1");n.appendChild(c)}UI.Element.call(this);a=a||[];b=b||20;c=c||300;d=d||function(){};var g=document.createElement("div");g.className=
"VirtualList";g.style.height=c+"px";var h=a.length,k=Math.ceil(c/b),l=3*k,m,r=k*b,q=0,t=function(){},n=document.createElement("div");n.style.width="100%";n.style.height=c+"px";n.style["overflow-y"]="auto";n.style.position="relative";n.style.padding=0;var p=document.createElement("div");p.style.opacity=0;p.style.position="absolute";p.style.top=0;p.style.left=0;p.style.width="1px";p.style.height=b*h+"px";var s=setInterval(function(){for(var a=g;a!==document&&a.parentNode;)a=a.parentNode;a!==document&&
clearInterval(s);if(100<Date.now()-q)for(var a=n.querySelectorAll('[data-rm="1"]'),b=0,c=a.length;b<c;b++)n.removeChild(a[b])},500);this.setItems=function(c){a=c;h=a.length;p.style.height=b*h+"px";f(0);return this};this.setItemHeight=function(a){b=a;k=Math.ceil(c/b);l=3*k;r=k*b;p.style.height=b*h+"px";f(0);return this};this.setHeight=function(a){UI.Element.prototype.setHeight.call(this,a+"px");c=a;k=Math.ceil(c/b);l=3*k;r=k*b;n.style.height=c+"px";p.style.height=c+"px";f(0);return this};this.setGeneratorFn=
function(a){d=a;f(0);return this};this.setRenderChunkCallback=function(a){t=a};this.redraw=function(){f(Math.max(0,Math.floor(n.scrollTop/b)-k));m=n.scrollTop;return this};n.appendChild(p);g.appendChild(n);n.addEventListener("scroll",function(a){var c=a.target.scrollTop;if(!m||Math.abs(c-m)>r)f(Math.max(0,Math.floor(c/b)-k)),m=c;q=Date.now();a.preventDefault&&a.preventDefault()});f(0);this.dom=g;return this};UI.VirtualList.prototype=Object.create(UI.Element.prototype);
UI.VirtualTable=function(a,b,c,d,e){e=e||{};UI.Panel.call(this);var f=void 0!==e.defaultWidth?e.defaultWidth:30,g=void 0!==e.defaultMargin?e.defaultMargin:5,h=void 0!==e.defaultAlign?e.defaultAlign:"left",k=e.onRowSelect,l=(new UI.Panel).setWhiteSpace("nowrap").setDisplay("inline-block").setOverflow("").setWidth("100%"),m=0,r=[],q=function(a,b){return a-b},t=function(a,b){return a.localeCompare(b)},n=function(b,c){var d;d="string"===typeof a[0][b]?t:q;a.sort(function(a,e){return c?d(e[b],a[b]):d(a[b],
e[b])});s.redraw();return this},p=function(b,c){r.length=0;k&&k(b,c);void 0!==c&&r.push(a[c][0]);s.redraw();return this};d.forEach(function(a){var b=a.width||f,c=a.margin||g,d=(new UI.EllipsisText).setValue(a.name).setWidth(b+"px").setTextAlign(a.align||h).setMarginLeft(c+"px").setMarginRight(c+"px").setCursor("pointer").onClick(function(b){b="ASC"===a.__sortFlag;n(a.index,b);a.__sortFlag=b?"DESC":"ASC"});l.add(d);m+=b+2*c});var s=(new UI.VirtualList(a,b,c,function(b){var c=new UI.Panel;d.forEach(function(d){var e=
a[b][d.index];d.format&&(e=d.format(e));var q=d.width||f,l=d.margin||g,k;k="object"===typeof e?e:(new UI.Text).setValue(e);k.setWidth(q+"px").setTextAlign(d.align||h).setMarginLeft(l+"px").setMarginRight(l+"px").onClick(function(a){if("function"===typeof d.onClick)d.onClick(a,b,e)}).onMouseOver(function(a){if("function"===typeof d.onMouseOver)d.onMouseOver(a,b,e)}).onMouseOut(function(a){if("function"===typeof d.onMouseOut)d.onMouseOut(a,b,e)});c.add(k)});c.setCursor("pointer").onClick(function(a){p(a,
b)});-1!==r.indexOf(a[b][0])&&c.dom.classList.add("highlight");return c.dom})).setWidth(m+20+"px");this.add(l,s);this.header=l;this.list=s;this.sortColumn=n;this.selectRow=function(a){p(void 0,a)};return this};UI.VirtualTable.prototype=Object.create(UI.Panel.prototype);
...
NGL.StageWidget=function(a){function b(a){d.href="light"===a?NGL.cssDirectory+"light.css":NGL.cssDirectory+"dark.css"}var c=a.signals,d=document.createElement("link");d.rel="stylesheet";d.id="theme";b(a.getParameters().theme);document.head.appendChild(d);c.themeChanged.add(b);var e=(new NGL.ViewportWidget(a)).setId("viewport");document.body.appendChild(e.dom);var f=(new NGL.ToolbarWidget(a)).setId("toolbar");document.body.appendChild(f.dom);c=(new NGL.MenubarWidget(a)).setId("menubar");document.body.appendChild(c.dom);
var g=(new NGL.SidebarWidget(a)).setId("sidebar");document.body.appendChild(g.dom);document.body.addEventListener("touchmove",function(a){a.preventDefault()},!1);a.handleResize();setTimeout(function(){a.handleResize()},500);var h=!1,k=!1,l=!1,m=function(b){50<=b&&b<=window.innerWidth-10&&(g.setWidth(window.innerWidth-b+"px"),e.setWidth(b+"px"),f.setWidth(b+"px"),a.handleResize());var c=g.dom.getBoundingClientRect().width;void 0===b&&(b=window.innerWidth-c,e.setWidth(b+"px"),f.setWidth(b+"px"),a.handleResize());
l=10>=c?!0:!1},m=NGL.throttle(m,50,{leading:!0,trailing:!0}),r=(new UI.Panel).setClass("ResizeLeft").onMouseDown(function(){h=!0;k=!1}).onClick(function(){l?m(window.innerWidth-300):h||k||m(window.innerWidth-10)});g.add(r);window.addEventListener("mousemove",function(a){h&&(document.body.style.cursor="col-resize",k=!0,m(a.clientX))},!1);window.addEventListener("mouseup",function(a){h=!1;document.body.style.cursor=""},!1);window.addEventListener("resize",function(a){m()},!1);document.addEventListener("dragover",
function(a){a.stopPropagation();a.preventDefault();a.dataTransfer.dropEffect="none"},!1);document.addEventListener("drop",function(a){a.stopPropagation();a.preventDefault()},!1);this.viewport=e;this.toolbar=f;this.menubar=c;this.sidebar=g;return this};
...
NGL.MenubarViewWidget=function(a){a.signals.fullscreenChanged.add(function(a){var b=d[3].children[0];a?b.switchClass("compress","expand"):b.switchClass("expand","compress")});var b=UI.MenubarHelper.createOption,c=UI.MenubarHelper.createDivider,d=[b("Light theme",function(){a.setParameters({theme:"light"})}),b("Dark theme",function(){a.setParameters({theme:"dark"})}),c(),b("Full screen",function(){a.toggleFullscreen(document.body)},"expand"),b("Center",function(){a.centerView()},"bullseye"),c(),b("Spin on",
function(){a.setSpin([0,1,0],.005)}),b("Spin off",function(){a.setSpin(null,null)}),c(),b("Orientation",function(){window.prompt("Orientation",JSON.stringify(a.viewer.getOrientation()))})],b=UI.MenubarHelper.createOptionsPanel(d);return UI.MenubarHelper.createMenuContainer("View",b)};
...
NGL.MenubarHelpWidget=function(a){function b(){d.setOpacity("0.9").setLeft("50px").setTop("80px").setDisplay("block")}var c=(new NGL.PreferencesWidget(a)).setDisplay("none").attach(),d=(new NGL.OverviewWidget(a)).setDisplay("none").attach();a.preferences.getKey("overview")&&b();var e=UI.MenubarHelper.createOption,f=UI.MenubarHelper.createDivider,e=[e("Overview",b),e("Documentation",function(){window.open(NGL.documentationUrl,"_blank")}),f(),e("Debug on",function(){NGL.debug=!0;a.viewer.updateHelper();
a.viewer.requestRender()}),e("Debug off",function(){NGL.debug=!1;a.viewer.updateHelper();a.viewer.requestRender()}),f(),e("Prefereces",function(){c.setOpacity("0.9").setLeft("50px").setTop("80px").setDisplay("block")},"sliders")],e=UI.MenubarHelper.createOptionsPanel(e);return UI.MenubarHelper.createMenuContainer("Help",e)};
...
e.add((new UI.Panel).add(new UI.Html("For more information please visit the <a href='"+NGL.documentationUrl+"' target='_blank'>documentation pages</a>.")));var d=a.preferences.getKey("overview"),f=(new UI.Checkbox(d)).onClick(function(){a.preferences.setKey("overview",f.getValue())});e.add((new UI.HorizontalRule).setBorderTop("1px solid #555").setMarginTop("15px")).add((new UI.Panel).add(f,(new UI.Text("Show on startup. Always available from Menu > Help > Overview.")).setMarginLeft("5px")));return c};
NGL.PreferencesWidget=function(a){var b=new UI.OverlayPanel,c=(new UI.Panel).setBorderBottom("1px solid #555").setHeight("25px"),d=(new UI.Panel).setMarginTop("10px").setMinHeight("100px").setMaxHeight("500px").setOverflow("auto");c.add(new UI.Text("Preferences"));c.add((new UI.Icon("times")).setCursor("pointer").setMarginLeft("20px").setFloat("right").onClick(function(){b.setDisplay("none")}));b.add(c);b.add(d);Object.keys(a.parameters).forEach(function(b){function c(){var d={};d[b]=h.getValue();
a.preferences.setKey(b,d[b])}var g=a.parameters[b];void 0===g.label&&(g.label=b);var h=NGL.createParameterInput(g);if(h){a.preferences.signals.keyChanged.add(function(a,c){a===b&&h.setValue(c)});if("range"===g.type)h.onInput(c);else h.onChange(c);d.add((new UI.Text(b)).setWidth("120px")).add(h).add(new UI.Break)}});return b};
...
k=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){a.removeAllComponents()}),l=(new UI.PopupMenu("cogs","Settings","window")).setIconTitle("settings").setMarginLeft("10px");l.entryLabelWidth="120px";var m=(new UI.Panel).setDisplay("inline").add((new UI.Icon("spinner")).addClass("spin").setMarginLeft("45px"));a.tasks.signals.countChanged.add(function(a,b){if(0<b)r.add(m);else try{r.remove(m)}catch(c){}});"clipNear clipFar clipDist fogNear fogFar lightColor lightIntensity ambientColor ambientIntensity".split(" ").forEach(function(b){function c(){var d=
...
NGL.ComponentWidget=function(a,b){var c=a.signals,d=new UI.CollapsibleIconPanel("minus-square","plus-square");c.requestGuiVisibility.add(function(a){d.setCollapsed(!a)});c.statusChanged.add(function(b){b={404:"Error: file not found"}[a.status]||a.status;d.setCollapsed(!1);d.add((new UI.Text(b)).setMarginLeft("20px").setWidth("200px").setWordWrap("break-word"));d.removeStatic(e);d.addStatic(f)});var c=(new UI.EllipsisText(NGL.unicodeHelper(a.name))).setWidth("100px"),e=(new UI.Panel).setDisplay("inline").add((new UI.Icon("spinner")).addClass("spin").setMarginLeft("25px")),
f=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){b.removeComponent(a)});d.addStatic(c,e);return d};
NGL.StructureComponentWidget=function(a,b){function c(){var c={"":"[ structure ]"};b.eachComponent(function(b,d){b!==a&&(c[d]=NGL.unicodeHelper(b.name))},NGL.StructureComponent);q.setOptions(c)}var d=a.signals,e=new UI.CollapsibleIconPanel("minus-square","plus-square"),f=new UI.Panel,g=new UI.Panel;d.requestGuiVisibility.add(function(a){e.setCollapsed(!a)});d.representationAdded.add(function(a){f.add(new NGL.RepresentationComponentWidget(a,b))});d.trajectoryAdded.add(function(a){g.add(new NGL.TrajectoryComponentWidget(a,
b))});d.defaultAssemblyChanged.add(function(){k.setValue(a.defaultAssembly)});e.add((new UI.SelectionPanel(a.selection)).setMarginLeft("20px").setInputWidth("214px"));var d=(new UI.Button("export")).onClick(function(){(new NGL.PdbWriter(a.structure)).download("structure");n.setMenuDisplay("none")}),h=(new UI.Select).setColor("#444").setOptions(function(){var a={"":"[ add ]"},b;for(b in NGL.representationTypes)a[b]=b;return a}()).onChange(function(){a.addRepresentation(h.getValue());h.setValue("");
n.setMenuDisplay("none")}),k=(new UI.Select).setColor("#444").setOptions(function(){var b={"":"AU"};Object.keys(a.structure.biomolDict).forEach(function(a){b[a]=a});return b}()).setValue(a.defaultAssembly).onChange(function(){a.setDefaultAssembly(k.getValue());n.setMenuDisplay("none")}),l=document.createElement("input");l.type="file";l.multiple=!0;l.style.display="none";l.accept=".dcd,.dcd.gz";l.addEventListener("change",function(b){new NGL.Queue(function(b,c){var d=NGL.autoLoad(b).then(function(a){c();
return a});a.addTrajectory(d)},b.target.files)},!1);var m=(new UI.Button("import")).onClick(function(){l.click();n.setMenuDisplay("none")}),r=(new UI.Button("import")).onClick(function(){n.setMenuDisplay("none");var c=["xtc","trr","dcd","netcdf","nc"],d;d=new NGL.DirectoryListingWidget(NGL.DatasourceRegistry.listing,b,"Import trajectory",c,function(b){var e=b.path.split(".").pop().toLowerCase();-1!==c.indexOf(e)?(a.addTrajectory(b.path),d.dispose()):NGL.log("unknown trajectory type: "+e)});d.setOpacity("0.9").setLeft("50px").setTop("80px").attach()});
b.signals.componentAdded.add(c);b.signals.componentRemoved.add(c);var q=(new UI.Select).setColor("#444").onChange(function(){a.superpose(b.compList[q.getValue()],!0);a.centerView();q.setValue("");n.setMenuDisplay("none")});c();var t=(new UI.Button("calculate")).onClick(function(){NGL.calculateSecondaryStructure(a.structure);a.rebuildRepresentations();n.setMenuDisplay("none")}),n=(new UI.ComponentPanel(a)).setDisplay("inline-block").setMargin("0px").addMenuEntry("PDB file",d).addMenuEntry("Representation",
h).addMenuEntry("Assembly",k).addMenuEntry("Superpose",q).addMenuEntry("SS",t).addMenuEntry("File",(new UI.Text(a.structure.path)).setMaxWidth("100px").setOverflow("auto")).addMenuEntry("Trajectory",m);NGL.DatasourceRegistry.listing&&NGL.DatasourceRegistry.trajectory&&n.addMenuEntry("Remote trajectory",r);e.addStatic(n).add(g).add(f);return e};
NGL.SurfaceComponentWidget=function(a,b){var c=a.signals,d=new UI.CollapsibleIconPanel("minus-square","plus-square"),e=new UI.Panel;c.requestGuiVisibility.add(function(a){d.setCollapsed(!a)});c.representationAdded.add(function(a){e.add(new NGL.RepresentationComponentWidget(a,b))});var f=(new UI.Select).setColor("#444").setOptions({"":"[ add ]",surface:"surface",dot:"dot"}).onChange(function(){a.addRepresentation(f.getValue());f.setValue("");g.setMenuDisplay("none")}),g=(new UI.ComponentPanel(a)).setDisplay("inline-block").setMargin("0px").addMenuEntry("Representation",
f).addMenuEntry("File",(new UI.Text(a.surface.path)).setMaxWidth("100px").setWordWrap("break-word"));d.addStatic(g).add(e);return d};
NGL.ScriptComponentWidget=function(a,b){var c=a.signals,d=new UI.CollapsibleIconPanel("minus-square","plus-square"),e=(new UI.Panel).setMarginLeft("20px");c.requestGuiVisibility.add(function(a){d.setCollapsed(!a)});c.nameChanged.add(function(a){g.setValue(NGL.unicodeHelper(a))});c.statusChanged.add(function(a){"finished"===a&&(d.removeStatic(h),d.addStatic(f))});a.script.signals.elementAdded.add(function(a){e.add.apply(e,a)});a.script.signals.elementRemoved.add(function(a){e.remove.apply(e,a)});var f=
(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){b.removeComponent(a)}),g=(new UI.EllipsisText(NGL.unicodeHelper(a.name))).setWidth("100px"),h=(new UI.Icon("spinner")).addClass("spin").setMarginLeft("25px");d.addStatic(g).addStatic(h);d.add(e);return d};
NGL.RepresentationComponentWidget=function(a,b){var c=a.signals,d=(new UI.CollapsibleIconPanel("minus-square","plus-square")).setMarginLeft("20px");c.requestGuiVisibility.add(function(a){d.setCollapsed(!a)});c.visibilityChanged.add(function(a){f.setValue(a)});c.nameChanged.add(function(a){e.setValue(NGL.unicodeHelper(a))});c.disposed.add(function(){h.dispose();d.dispose()});var e=(new UI.EllipsisText(NGL.unicodeHelper(a.name))).setWidth("103px"),f=(new UI.ToggleIcon(a.visible,"eye","eye-slash")).setTitle("hide/show").setCursor("pointer").setMarginLeft("25px").onClick(function(){a.setVisibility(!a.visible)}),
...
NGL.TrajectoryComponentWidget=function(a,b){function c(a){h.clear().add(l.setWidth("70px"));l.setRange(-1,a-1);r.setRange(-1,a-1);m.setValue(Math.ceil((a+1)/100));p.step=m.getValue();p.end=a}var d=a.signals,e=a.trajectory,f=(new UI.CollapsibleIconPanel("minus-square","plus-square")).setMarginLeft("20px"),g=new UI.Panel;d.representationAdded.add(function(a){g.add(new NGL.RepresentationComponentWidget(a,b))});d.disposed.add(function(){x.dispose();f.dispose()});var h=(new UI.Panel).setMarginLeft("10px").setDisplay("inline").add((new UI.Icon("spinner")).addClass("spin").setMarginRight("69px"));
d.gotNumframes.add(c);d.frameChanged.add(function(a){l.setValue(a);r.setValue(a);h.clear().add(l.setWidth("70px"))});var k=(new UI.EllipsisText(e.name)).setWidth("108px");f.addStatic(k);f.addStatic(h);var l=(new UI.Integer(-1)).setMarginLeft("5px").setWidth("70px").setRange(-1,-1).onChange(function(a){e.setFrame(l.getValue());x.setMenuDisplay("none")}),m=(new UI.Integer(1)).setWidth("30px").setRange(1,1E4).onChange(function(){p.step=m.getValue()}),k=new UI.Panel,r=(new UI.Range(-1,-1,-1,1)).setWidth("197px").setMargin("0px").setPadding("0px").setBorder("0px").onInput(function(a){a=
r.getValue();a!==e.currentFrame&&(e.player&&e.player._running?(e.setPlayer(),e.setFrame(a)):e.inProgress||e.setFrame(a))}),q=(new UI.Select).setColor("#444").setOptions({"":"none",linear:"linear",spline:"spline"}).onChange(function(){p.interpolateType=q.getValue()}),t=(new UI.Integer(5)).setWidth("30px").setRange(1,50).onChange(function(){p.interpolateStep=t.getValue()}),n=(new UI.Integer(50)).setWidth("30px").setRange(10,1E3).onChange(function(){p.timeout=n.getValue()}),p=new NGL.TrajectoryPlayer(e,
m.getValue(),n.getValue(),0,e.numframes),s=(new UI.ToggleIcon(!0,"play","pause")).setMarginRight("10px").setMarginLeft("20px").setCursor("pointer").setWidth("12px").setTitle("play").onClick(function(){p.toggle()});p.signals.startedRunning.add(function(){s.setTitle("pause").setValue(!1)});p.signals.haltedRunning.add(function(){s.setTitle("play").setValue(!0)});k.add(s);k.add(r);var y=(new UI.Select).setColor("#444").setOptions({forward:"forward",backward:"backward"}).onChange(function(){p.direction=
...
u).addEntry("Remove PBC",v).addEntry("Superpose",w).addEntry("Step size",m).addEntry("Interpolation type",q).addEntry("Interpolation steps",t).addEntry("Play timeout",n).addEntry("Play direction",y).addEntry("Play mode",z).addEntry("File",(new UI.Text(e.trajPath)).setMaxWidth("100px").setWordWrap("break-word")).addEntry("Dispose",A);f.addStatic(x);f.add(k);f.add(g);return f};
NGL.DirectoryListingWidget=function(a,b,c,d,e){function f(a,b,c,d,e){return(b=Math,c=b.log,d=1E3,e=c(a)/c(d)|0,a/b.pow(d,e)).toFixed(2)+String.fromCharCode(160)+(e?"kMGTPEZY"[--e]+"B":"Bytes")}function g(a){var b={"":""},c=[];(a||"").split("/").forEach(function(a){c.push(a);b[c.join("/")]=a});return b}function h(b){var c=b.path;b=b.data;NGL.lastUsedDirectory=c;l.clear();m.setOptions(g(c)).setValue(c);b.forEach(function(b){var c=b.path.split(".").pop().toLowerCase();if(!d||b.dir||-1!==d.indexOf(c)){var g;
