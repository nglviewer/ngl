...
return c};
NGL.PreferencesWidget=function(a){var b=new UI.OverlayPanel,c=(new UI.Panel).setBorderBottom("1px solid #555").setHeight("25px"),d=(new UI.Panel).setMarginTop("10px").setMinHeight("100px").setMaxHeight("500px").setOverflow("auto");c.add(new UI.Text("Preferences"));c.add((new UI.Icon("times")).setCursor("pointer").setMarginLeft("20px").setFloat("right").onClick(function(){b.setDisplay("none")}));b.add(c);b.add(d);Object.keys(a.parameters).forEach(function(b){function c(){var d={};d[b]=h.getValue();a.preferences.setKey(b,
d[b])}var g=a.parameters[b];void 0===g.label&&(g.label=b);var h=NGL.createParameterInput(g);if(h){a.preferences.signals.keyChanged.add(function(a,c){a===b&&h.setValue(c)});if("range"===g.type)h.onInput(c);else h.onChange(c);d.add((new UI.Text(b)).setWidth("120px")).add(h).add(new UI.Break)}});return b};
