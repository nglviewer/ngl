...
b))});e.add((new UI.SelectionPanel(a.selection)).setMarginLeft("20px").setInputWidth("214px"));var d=(new UI.Button("export")).onClick(function(){(new NGL.PdbWriter(a.structure)).download("structure");n.setMenuDisplay("none")}),h=(new UI.Select).setColor("#444").setOptions(function(){var a={"":"[ add ]"},b;for(b in NGL.representationTypes)a[b]=b;return a}()).onChange(function(){a.addRepresentation(h.getValue());h.setValue("");n.setMenuDisplay("none")}),k=(new UI.Select).setColor("#444").setOptions(function(){var b=
{__AU:"AU"};Object.keys(a.structure.biomolDict).forEach(function(a){b[a]=a});return b}()).setValue(a.structure.defaultAssembly).onChange(function(){a.structure.setDefaultAssembly(k.getValue());a.rebuildRepresentations();n.setMenuDisplay("none")}),l=document.createElement("input");l.type="file";l.multiple=!0;l.style.display="none";l.accept=".dcd,.dcd.gz";l.addEventListener("change",function(b){new NGL.Queue(function(b,c){var d=NGL.autoLoad(b).then(function(a){c();return a});a.addTrajectory(d)},b.target.files)},
!1);var m=(new UI.Button("import")).onClick(function(){l.click();n.setMenuDisplay("none")}),r=(new UI.Button("import")).onClick(function(){n.setMenuDisplay("none");var c=["xtc","trr","dcd","netcdf","nc"],d;d=new NGL.DirectoryListingWidget(NGL.DatasourceRegistry.listing,b,"Import trajectory",c,function(b){var e=b.path.split(".").pop().toLowerCase();-1!==c.indexOf(e)?(a.addTrajectory(b.path),d.dispose()):NGL.log("unknown trajectory type: "+e)});d.setOpacity("0.9").setLeft("50px").setTop("80px").attach()});
