...
"VirtualList";g.style.height=c+"px";var h=a.length,k=Math.ceil(c/b),l=3*k,n,r=k*b,q=0,t=function(){},p=document.createElement("div");p.style.width="100%";p.style.height=c+"px";p.style["overflow-y"]="auto";p.style.position="relative";p.style.padding=0;var m=document.createElement("div");m.style.opacity=0;m.style.position="absolute";m.style.top=0;m.style.left=0;m.style.width="1px";m.style.height=b*h+"px";var s=setInterval(function(){for(var a=g;a!==document&&a.parentNode;)a=a.parentNode;a!==document&&
clearInterval(s);if(100<Date.now()-q)for(var a=p.querySelectorAll('[data-rm="1"]'),b=0,c=a.length;b<c;b++)p.removeChild(a[b])},500);this.setItems=function(c){a=c;h=a.length;m.style.height=b*h+"px";f(0);return this};this.setItemHeight=function(a){b=a;k=Math.ceil(c/b);l=3*k;r=k*b;m.style.height=b*h+"px";f(0);return this};this.setHeight=function(a){UI.Element.prototype.setHeight.call(this,a+"px");c=a;k=Math.ceil(c/b);l=3*k;r=k*b;p.style.height=c+"px";m.style.height=c+"px";f(0);return this};this.setGeneratorFn=
function(a){d=a;f(0);return this};this.setRenderChunkCallback=function(a){t=a};this.redraw=function(){f(Math.max(0,Math.floor(p.scrollTop/b)-k));n=p.scrollTop;return this};p.appendChild(m);g.appendChild(p);p.addEventListener("scroll",function(a){var c=a.target.scrollTop;if(!n||Math.abs(c-n)>r)f(Math.max(0,Math.floor(c/b)-k)),n=c;q=Date.now();a.preventDefault&&a.preventDefault()});f(0);this.dom=g;return this};UI.VirtualList.prototype=Object.create(UI.Element.prototype);
UI.VirtualTable=function(a,b,c,d,e){e=e||{};UI.Panel.call(this);var f=void 0!==e.defaultWidth?e.defaultWidth:30,g=void 0!==e.defaultMargin?e.defaultMargin:5,h=void 0!==e.defaultAlign?e.defaultAlign:"left",k=e.onRowSelect,l=(new UI.Panel).setWhiteSpace("nowrap").setDisplay("inline-block").setOverflow("").setWidth("100%"),n=0,r=[],q=function(a,b){return a-b},t=function(a,b){return a.localeCompare(b)},p=function(b,c){var d;d="string"===typeof a[0][b]?t:q;a.sort(function(a,e){return c?d(e[b],a[b]):d(a[b],
e[b])});s.redraw();return this},m=function(b,c){r.length=0;k&&k(b,c);void 0!==c&&r.push(a[c][0]);s.redraw();return this};d.forEach(function(a){var b=a.width||f,c=a.margin||g,d=(new UI.EllipsisText).setValue(a.name).setWidth(b+"px").setTextAlign(a.align||h).setMarginLeft(c+"px").setMarginRight(c+"px").setCursor("pointer").onClick(function(b){b="ASC"===a.__sortFlag;p(a.index,b);a.__sortFlag=b?"DESC":"ASC"});l.add(d);n+=b+2*c});var s=(new UI.VirtualList(a,b,c,function(b){var c=new UI.Panel;d.forEach(function(d){var e=
a[b][d.index];d.format&&(e=d.format(e));var q=d.width||f,l=d.margin||g,k;k="object"===typeof e?e:(new UI.Text).setValue(e);k.setWidth(q+"px").setTextAlign(d.align||h).setMarginLeft(l+"px").setMarginRight(l+"px").onClick(function(a){if("function"===typeof d.onClick)d.onClick(a,b,e)}).onMouseOver(function(a){if("function"===typeof d.onMouseOver)d.onMouseOver(a,b,e)}).onMouseOut(function(a){if("function"===typeof d.onMouseOut)d.onMouseOut(a,b,e)});c.add(k)});c.setCursor("pointer").onClick(function(a){m(a,
b)});-1!==r.indexOf(a[b][0])&&c.dom.classList.add("highlight");return c.dom})).setWidth(n+20+"px");this.add(l,s);this.header=l;this.list=s;this.sortColumn=p;this.selectRow=function(a){m(void 0,a)};return this};UI.VirtualTable.prototype=Object.create(UI.Panel.prototype);
...
var g=(new NGL.SidebarWidget(a)).setId("sidebar");document.body.appendChild(g.dom);a.handleResize();setTimeout(function(){a.handleResize()},500);var h=!1,k=!1,l=!1,n=function(b){50<=b&&b<=window.innerWidth-10&&(g.setWidth(window.innerWidth-b+"px"),e.setWidth(b+"px"),f.setWidth(b+"px"),a.handleResize());var c=g.dom.getBoundingClientRect().width;void 0===b&&(b=window.innerWidth-c,e.setWidth(b+"px"),f.setWidth(b+"px"),a.handleResize());l=10>=c?!0:!1},n=NGL.throttle(n,50,{leading:!0,trailing:!0}),r=(new UI.Panel).setClass("ResizeLeft").onMouseDown(function(){h=
!0;k=!1}).onClick(function(){l?n(window.innerWidth-300):h||k||n(window.innerWidth-10)});g.add(r);window.addEventListener("mousemove",function(a){h&&(document.body.style.cursor="col-resize",k=!0,n(a.clientX))},!1);window.addEventListener("mouseup",function(a){h=!1;document.body.style.cursor=""},!1);window.addEventListener("resize",function(a){n()},!1);document.addEventListener("dragover",function(a){a.stopPropagation();a.preventDefault();a.dataTransfer.dropEffect="none"},!1);document.addEventListener("drop",
...
a.volume.volume.name+")":"Nothing to pick";d.clear().add(new UI.Text(a))});a.viewer.stats.signals.updated.add(function(){e.clear().add(new UI.Text(a.viewer.stats.lastDuration+" ms | "+a.viewer.stats.lastFps+" fps"))});c.add(d);NGL.debug&&c.add(e);return c};
...
function(){a.viewer.screenshot({factor:1,type:"image/png",quality:1,antialias:!0,transparent:!1,trim:!1})},"camera"),c("Export image...",function(){f.setOpacity("0.9").setLeft("50px").setTop("80px").setDisplay("block")})];NGL.DatasourceRegistry.listing&&g.splice(1,0,c("Import...",b));c=UI.MenubarHelper.createOptionsPanel(g);c.dom.appendChild(e);return UI.MenubarHelper.createMenuContainer("File",c)};
NGL.MenubarViewWidget=function(a){a.signals.fullscreenChanged.add(function(a){var b=d[3].children[0];a?b.switchClass("compress","expand"):b.switchClass("expand","compress")});var b=UI.MenubarHelper.createOption,c=UI.MenubarHelper.createDivider,d=[b("Light theme",function(){a.setParameters({theme:"light"})}),b("Dark theme",function(){a.setParameters({theme:"dark"})}),c(),b("Full screen",function(){a.toggleFullscreen(document.body)},"expand"),b("Center",function(){a.centerView()},"bullseye"),c(),b("Orientation",
function(){window.prompt("Orientation",JSON.stringify(a.viewer.getOrientation()))})],b=UI.MenubarHelper.createOptionsPanel(d);return UI.MenubarHelper.createMenuContainer("View",b)};
...
NGL.MenubarHelpWidget=function(a){function b(){d.setOpacity("0.9").setLeft("50px").setTop("80px").setDisplay("block")}var c=(new NGL.PreferencesWidget(a)).setDisplay("none").attach(),d=(new NGL.OverviewWidget(a)).setDisplay("none").attach();a.preferences.getKey("overview")&&b();a=UI.MenubarHelper.createOption;var e=UI.MenubarHelper.createDivider;a=[a("Overview",b),a("Documentation",function(){window.open(NGL.documentationUrl,"_blank")}),e(),a("Prefereces",function(){c.setOpacity("0.9").setLeft("50px").setTop("80px").setDisplay("block")},
...
c.add(e);var f=(new UI.Select).setOptions({1:"1x",2:"2x",3:"3x",4:"4x",5:"5x",6:"6x",7:"7x",8:"8x",9:"9x",10:"10x"}).setValue("4");(new UI.Select).setOptions({"image/png":"PNG","image/jpeg":"JPEG"}).setValue("image/png");(new UI.Select).setOptions({"0.1":"0.1","0.2":"0.2","0.3":"0.3","0.4":"0.4","0.5":"0.5","0.6":"0.6","0.7":"0.7","0.8":"0.8","0.9":"0.9","1.0":"1.0"}).setValue("1.0");var g=(new UI.Checkbox).setValue(!0),h=(new UI.Checkbox).setValue(!1),k=(new UI.Checkbox).setValue(!1),l=(new UI.Progress).setDisplay("none"),
n=(new UI.Button("export")).onClick(function(){n.setDisplay("none");l.setDisplay("inline-block");setTimeout(function(){a.exportImage(parseInt(f.getValue()),g.getValue(),h.getValue(),k.getValue(),function(a,b,c){1===a&&l.setMax(b);a>=b?l.setIndeterminate():l.setValue(a);c&&(l.setDisplay("none"),n.setDisplay("inline-block"))})},50)});b("scale",f);b("antialias",g);b("transparent",h);b("trim",k);e.add(new UI.Break,n,l);return c};
...
{__AU:"AU"};Object.keys(a.structure.biomolDict).forEach(function(a){b[a]=a});return b}()).setValue(a.structure.defaultAssembly).onChange(function(){a.structure.setDefaultAssembly(k.getValue());a.rebuildRepresentations();m.setMenuDisplay("none")}),l=document.createElement("input");l.type="file";l.multiple=!0;l.style.display="none";l.accept=".dcd,.dcd.gz";l.addEventListener("change",function(b){new NGL.Queue(function(b,c){var d=NGL.autoLoad(b).then(function(a){c();return a});a.addTrajectory(d)},b.target.files)},
!1);var n=(new UI.Button("import")).onClick(function(){l.click();m.setMenuDisplay("none")}),r=(new UI.Button("import")).onClick(function(){m.setMenuDisplay("none");var c=["xtc","trr","dcd","netcdf","nc"],d;d=new NGL.DirectoryListingWidget(NGL.DatasourceRegistry.listing,b,"Import trajectory",c,function(b){var e=b.path.split(".").pop().toLowerCase();-1!==c.indexOf(e)?(a.addTrajectory(b.path),d.dispose()):NGL.log("unknown trajectory type: "+e)});d.setOpacity("0.9").setLeft("50px").setTop("80px").attach()});
b.signals.componentAdded.add(c);b.signals.componentRemoved.add(c);var q=(new UI.Select).setColor("#444").onChange(function(){a.superpose(b.compList[q.getValue()],!0);a.centerView();q.setValue("");m.setMenuDisplay("none")});c();var t=(new UI.Button("calculate")).onClick(function(){a.structure.autoSS();a.rebuildRepresentations();m.setMenuDisplay("none")}),p=(new UI.Button("duplicate")).onClick(function(){b.addComponent(new NGL.StructureComponent(b,a.structure.clone()));m.setMenuDisplay("none")}),m=
(new UI.ComponentPanel(a)).setDisplay("inline-block").setMargin("0px").addMenuEntry("PDB file",d).addMenuEntry("Representation",h).addMenuEntry("Assembly",k).addMenuEntry("Superpose",q).addMenuEntry("SS",t).addMenuEntry("Structure",p).addMenuEntry("File",(new UI.Text(a.structure.path)).setMaxWidth("100px").setOverflow("auto")).addMenuEntry("Trajectory",n);NGL.DatasourceRegistry.listing&&NGL.DatasourceRegistry.trajectory&&m.addMenuEntry("Remote trajectory",r);e.addStatic(m).add(g).add(f);return e};
...
NGL.TrajectoryComponentWidget=function(a,b){function c(a){h.clear().add(l.setWidth("70px"));l.setRange(-1,a-1);r.setRange(-1,a-1);n.setValue(Math.ceil((a+1)/100));m.step=n.getValue();m.end=a}var d=a.signals,e=a.trajectory,f=(new UI.CollapsibleIconPanel("database")).setMarginLeft("20px"),g=new UI.Panel;d.representationAdded.add(function(a){g.add(new NGL.RepresentationComponentWidget(a,b))});d.disposed.add(function(){x.dispose();f.dispose()});var h=(new UI.Panel).setMarginLeft("10px").setDisplay("inline").add((new UI.Icon("spinner")).addClass("spin").setMarginRight("69px"));
d.gotNumframes.add(c);d.frameChanged.add(function(a){l.setValue(a);r.setValue(a);h.clear().add(l.setWidth("70px"))});var k=(new UI.EllipsisText(e.name)).setWidth("108px");f.addStatic(k);f.addStatic(h);var l=(new UI.Integer(-1)).setMarginLeft("5px").setWidth("70px").setRange(-1,-1).onChange(function(a){e.setFrame(l.getValue());x.setMenuDisplay("none")}),n=(new UI.Integer(1)).setWidth("30px").setRange(1,1E4).onChange(function(){m.step=n.getValue()}),k=new UI.Panel,r=(new UI.Range(-1,-1,-1,1)).setWidth("197px").setMargin("0px").setPadding("0px").setBorder("0px").onInput(function(a){a=
r.getValue();a!==e.currentFrame&&(e.player&&e.player._running?(e.setPlayer(),e.setFrame(a)):e.inProgress||e.setFrame(a))}),q=(new UI.Select).setColor("#444").setOptions({"":"none",linear:"linear",spline:"spline"}).onChange(function(){m.interpolateType=q.getValue()}),t=(new UI.Integer(5)).setWidth("30px").setRange(1,50).onChange(function(){m.interpolateStep=t.getValue()}),p=(new UI.Integer(50)).setWidth("30px").setRange(10,1E3).onChange(function(){m.timeout=p.getValue()}),m=new NGL.TrajectoryPlayer(e,
n.getValue(),p.getValue(),0,e.numframes),s=(new UI.ToggleIcon(!0,"play","pause")).setMarginRight("10px").setMarginLeft("20px").setCursor("pointer").setWidth("12px").setTitle("play").onClick(function(){m.toggle()});m.signals.startedRunning.add(function(){s.setTitle("pause").setValue(!1)});m.signals.haltedRunning.add(function(){s.setTitle("play").setValue(!0)});k.add(s);k.add(r);var y=(new UI.Select).setColor("#444").setOptions({forward:"forward",backward:"backward"}).onChange(function(){m.direction=
y.getValue()}),z=(new UI.Select).setColor("#444").setOptions({loop:"loop",once:"once"}).onChange(function(){m.mode=z.getValue()});f.add((new UI.SelectionPanel(e.selection)).setMarginLeft("20px").setInputWidth("194px"));var u=(new UI.Checkbox(e.params.centerPbc)).onChange(function(){a.setParameters({centerPbc:u.getValue()})}),v=(new UI.Checkbox(e.params.removePbc)).onChange(function(){a.setParameters({removePbc:v.getValue()})}),w=(new UI.Checkbox(e.params.superpose)).onChange(function(){a.setParameters({superpose:w.getValue()})});
...
u).addEntry("Remove PBC",v).addEntry("Superpose",w).addEntry("Step size",n).addEntry("Interpolation type",q).addEntry("Interpolation steps",t).addEntry("Play timeout",p).addEntry("Play direction",y).addEntry("Play mode",z).addEntry("File",(new UI.Text(e.trajPath)).setMaxWidth("100px").setWordWrap("break-word")).addEntry("Dispose",A);f.addStatic(x);f.add(k);f.add(g);return f};
