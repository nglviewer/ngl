...
function(){a.setSpin([0,1,0],.01)}),b("Spin off",function(){a.setSpin(null,null)}),c(),b("Orientation",function(){window.prompt("Orientation",JSON.stringify(a.viewer.getOrientation()))})],b=UI.MenubarHelper.createOptionsPanel(d);return UI.MenubarHelper.createMenuContainer("View",b)};
...
c.add(e);var f=(new UI.Select).setOptions({1:"1x",2:"2x",3:"3x",4:"4x",5:"5x",6:"6x",7:"7x",8:"8x",9:"9x",10:"10x"}).setValue("4"),g=(new UI.Checkbox).setValue(!0),h=(new UI.Checkbox).setValue(!1),k=(new UI.Checkbox).setValue(!1),l=(new UI.Progress).setDisplay("none"),m=(new UI.Button("export")).onClick(function(){m.setDisplay("none");l.setDisplay("inline-block");setTimeout(function(){a.exportImage(parseInt(f.getValue()),g.getValue(),h.getValue(),k.getValue(),function(a,b,c){1===a&&l.setMax(b);a>=
b?l.setIndeterminate():l.setValue(a);c&&(l.setDisplay("none"),m.setDisplay("inline-block"))})},50)});b("scale",f);b("antialias",g);b("trim",h);b("transparent",k);e.add(new UI.Break,m,l);return c};
