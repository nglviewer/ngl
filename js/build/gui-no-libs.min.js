...
UI.Panel=function(){UI.Element.call(this);var a=document.createElement("div");a.className="Panel";this.dom=a;this.children=[];return this};UI.Panel.prototype=Object.create(UI.Element.prototype);UI.Panel.prototype.add=function(){for(var a=0;a<arguments.length;a++)this.dom.appendChild(arguments[a].dom),this.children.push(arguments[a]);return this};
UI.Panel.prototype.remove=function(){for(var a=0;a<arguments.length;a++){this.dom.removeChild(arguments[a].dom);var b=this.children.indexOf(arguments[a]);-1!==b&&this.children.splice(b,1)}return this};UI.Panel.prototype.clear=function(){for(;this.dom.children.length;)this.dom.removeChild(this.dom.lastChild);this.children.length=0;return this};
...
UI.Text.prototype.setName=function(a){this.dom.name=a;return this};UI.Input=function(a){UI.Element.call(this);var b=document.createElement("input");b.className="Input";b.style.padding="2px";b.style.border="1px solid #ccc";b.addEventListener("keydown",function(a){a.stopPropagation()},!1);this.dom=b;this.setValue(a||"");return this};UI.Input.prototype=Object.create(UI.Element.prototype);UI.Input.prototype.getValue=function(){return this.dom.value};
...
UI.Number=function(a){UI.Element.call(this);var b=this,c=document.createElement("input");c.className="Number";c.value="0.00";c.addEventListener("keydown",function(a){a.stopPropagation();13===a.keyCode&&c.blur()},!1);this.min=-Infinity;this.max=Infinity;this.precision=2;this.step=1;this.dom=c;this.setValue(a);var d=document.createEvent("HTMLEvents");d.initEvent("change",!0,!0);var e=0,f=0,g=[0,0],h=[0,0],k=function(a){var l=c.value;g=[a.clientX,a.clientY];e+=g[0]-h[0]-(g[1]-h[1]);var p=50;a.shiftKey&&
(p=5);a.ctrlKey&&(p=500);c.value=Math.min(b.max,Math.max(b.min,f+e/p*b.step)).toFixed(b.precision);l!==c.value&&c.dispatchEvent(d);h=[a.clientX,a.clientY]},l=function(a){document.removeEventListener("mousemove",k,!1);document.removeEventListener("mouseup",l,!1);2>Math.abs(e)&&(c.focus(),c.select())};c.addEventListener("mousedown",function(a){a.preventDefault();e=0;f=parseFloat(c.value);h=[a.clientX,a.clientY];document.addEventListener("mousemove",k,!1);document.addEventListener("mouseup",l,!1)},!1);
...
UI.Number.prototype.setValue=function(a){isNaN(a)?this.dom.value=NaN:void 0!==a&&(this.dom.value=a.toFixed(this.precision));return this};UI.Number.prototype.setRange=function(a,b){this.min=a;this.max=b;return this};UI.Number.prototype.setPrecision=function(a){this.precision=a;this.setValue(parseFloat(this.dom.value));return this};UI.Number.prototype.setName=function(a){this.dom.name=a;return this};
UI.Integer=function(a){UI.Element.call(this);var b=this,c=document.createElement("input");c.className="Number";c.value="0.00";c.addEventListener("keydown",function(a){a.stopPropagation()},!1);this.min=-Infinity;this.max=Infinity;this.step=1;this.dom=c;this.setValue(a);var d=document.createEvent("HTMLEvents");d.initEvent("change",!0,!0);var e=0,f=0,g=[0,0],h=[0,0],k=function(a){var l=c.value;g=[a.clientX,a.clientY];e+=g[0]-h[0]-(g[1]-h[1]);var p=50;a.shiftKey&&(p=5);a.ctrlKey&&(p=500);c.value=Math.min(b.max,
Math.max(b.min,f+e/p*b.step))|0;l!==c.value&&c.dispatchEvent(d);h=[a.clientX,a.clientY]},l=function(a){document.removeEventListener("mousemove",k,!1);document.removeEventListener("mouseup",l,!1);2>Math.abs(e)&&(c.focus(),c.select())};c.addEventListener("mousedown",function(a){a.preventDefault();e=0;f=parseFloat(c.value);h=[a.clientX,a.clientY];document.addEventListener("mousemove",k,!1);document.addEventListener("mouseup",l,!1)},!1);c.addEventListener("change",function(a){a=parseInt(c.value);!1===
...
UI.VirtualList=function(a,b,c,d){function e(a){var c=d(a);c.classList.add("VirtualListRow");c.style.height=b+"px";c.style.top=a*b+"px";return c}function f(a){var b=Math.min(h,a+l);s(a,b);for(var c=document.createDocumentFragment();a<b;a++)c.appendChild(e(a));b=1;for(a=m.childNodes.length;b<a;b++)m.childNodes[b].style.display="none",m.childNodes[b].setAttribute("data-rm","1");m.appendChild(c)}UI.Element.call(this);a=a||[];b=b||20;c=c||300;d=d||function(){};var g=document.createElement("div");g.className=
"VirtualList";g.style.height=c+"px";var h=a.length,k=Math.ceil(c/b),l=3*k,n,r=k*b,p=0,s=function(){},m=document.createElement("div");m.style.width="100%";m.style.height=c+"px";m.style["overflow-y"]="auto";m.style.position="relative";m.style.padding=0;var q=document.createElement("div");q.style.opacity=0;q.style.position="absolute";q.style.top=0;q.style.left=0;q.style.width="1px";q.style.height=b*h+"px";var t=setInterval(function(){for(var a=g;a!==document&&a.parentNode;)a=a.parentNode;a!==document&&
clearInterval(t);if(100<Date.now()-p)for(var a=m.querySelectorAll('[data-rm="1"]'),b=0,c=a.length;b<c;b++)m.removeChild(a[b])},500);this.setItems=function(c){a=c;h=a.length;q.style.height=b*h+"px";f(0);return this};this.setItemHeight=function(a){b=a;k=Math.ceil(c/b);l=3*k;r=k*b;q.style.height=b*h+"px";f(0);return this};this.setHeight=function(a){UI.Element.prototype.setHeight.call(this,a+"px");c=a;k=Math.ceil(c/b);l=3*k;r=k*b;m.style.height=c+"px";q.style.height=c+"px";f(0);return this};this.setGeneratorFn=
function(a){d=a;f(0);return this};this.setRenderChunkCallback=function(a){s=a};this.redraw=function(){f(Math.max(0,Math.floor(m.scrollTop/b)-k));n=m.scrollTop;return this};m.appendChild(q);g.appendChild(m);m.addEventListener("scroll",function(a){var c=a.target.scrollTop;if(!n||Math.abs(c-n)>r)f(Math.max(0,Math.floor(c/b)-k)),n=c;p=Date.now();a.preventDefault&&a.preventDefault()});f(0);this.dom=g;return this};UI.VirtualList.prototype=Object.create(UI.Element.prototype);
UI.VirtualTable=function(a,b,c,d,e){e=e||{};UI.Panel.call(this);var f=void 0!==e.defaultWidth?e.defaultWidth:30,g=void 0!==e.defaultMargin?e.defaultMargin:5,h=void 0!==e.defaultAlign?e.defaultAlign:"left",k=e.onRowSelect,l=(new UI.Panel).setWhiteSpace("nowrap").setDisplay("inline-block").setOverflow("").setWidth("100%"),n=0,r=[],p=function(a,b){return a-b},s=function(a,b){return a.localeCompare(b)},m=function(b,c){var d;d="string"===typeof a[0][b]?s:p;a.sort(function(a,e){return c?d(e[b],a[b]):d(a[b],
e[b])});t.redraw();return this},q=function(b,c){r.length=0;k&&k(b,c);void 0!==c&&r.push(a[c][0]);t.redraw();return this};d.forEach(function(a){var b=a.width||f,c=a.margin||g,d=(new UI.EllipsisText).setValue(a.name).setWidth(b+"px").setTextAlign(a.align||h).setMarginLeft(c+"px").setMarginRight(c+"px").setCursor("pointer").onClick(function(b){b="ASC"===a.__sortFlag;m(a.index,b);a.__sortFlag=b?"DESC":"ASC"});l.add(d);n+=b+2*c});var t=(new UI.VirtualList(a,b,c,function(b){var c=new UI.Panel;d.forEach(function(d){var e=
a[b][d.index];d.format&&(e=d.format(e));var p=d.width||f,l=d.margin||g,s;s="object"===typeof e?e:(new UI.Text).setValue(e);s.setWidth(p+"px").setTextAlign(d.align||h).setMarginLeft(l+"px").setMarginRight(l+"px").onClick(function(a){if("function"===typeof d.onClick)d.onClick(a,b,e)}).onMouseOver(function(a){if("function"===typeof d.onMouseOver)d.onMouseOver(a,b,e)}).onMouseOut(function(a){if("function"===typeof d.onMouseOut)d.onMouseOut(a,b,e)});c.add(s)});c.setCursor("pointer").onClick(function(a){q(a,
b)});-1!==r.indexOf(a[b][0])&&c.dom.classList.add("highlight");return c.dom})).setWidth(n+20+"px");this.add(l,t);this.header=l;this.list=t;this.sortColumn=m;this.selectRow=function(a){q(void 0,a)};return this};UI.VirtualTable.prototype=Object.create(UI.Panel.prototype);
...
NGL.createParameterInput=function(a){if(a){var b;"number"===a.type?b=(new UI.Number(parseFloat(a.value))).setRange(a.min,a.max).setPrecision(a.precision):"integer"===a.type?b=(new UI.Integer(parseInt(a.value))).setRange(a.min,a.max):"range"===a.type?b=(new UI.Range(a.min,a.max,a.value,a.step)).setValue(parseFloat(a.value)):"boolean"===a.type?b=new UI.Checkbox(a.value):"text"===a.type?b=new UI.Input(a.value):"select"===a.type?b=(new UI.Select).setWidth("").setOptions(a.options).setValue(a.value):"button"===
a.type?b=(new UI.Button(a.label)).onClick(function(){a.value()}):"color"===a.type?b=(new UI.ColorPopupMenu(a.label)).setValue(a.value):"hidden"!==a.type&&NGL.warn("NGL.createParameterInput: unknown parameter type '"+a.type+"'");return b}};
NGL.Preferences=function(a,b){this.signals={keyChanged:new signals.Signal};this.id=a||"ngl-gui";var c=Object.assign({},b);this.storage={impostor:!0,quality:"medium",sampleLevel:0,theme:"dark",backgroundColor:"black",overview:!0,rotateSpeed:2,zoomSpeed:1.2,panSpeed:.8,clipNear:0,clipFar:100,clipDist:10,fogNear:50,fogFar:100,cameraFov:40,cameraType:"perspective",lightColor:14540253,lightIntensity:1,ambientColor:14540253,ambientIntensity:.2};for(var d in this.storage)void 0!==c[d]&&(this.storage[d]=
c[d]);try{if(void 0===window.localStorage[this.id])window.localStorage[this.id]=JSON.stringify(this.storage);else{var e=JSON.parse(window.localStorage[this.id]);for(d in e)this.storage[d]=e[d]}}catch(f){NGL.error("localStorage not accessible/available")}};
...
NGL.StageWidget=function(a){function b(b){var c;"light"===b?(b=NGL.cssDirectory+"light.css",c="white"):(b=NGL.cssDirectory+"dark.css",c="black");f.href=b;a.setParameters({backgroundColor:c})}var c=new NGL.Preferences("ngl-stage-widget"),d={},e;for(e in c.storage)d[e]=c.getKey(e);a.setParameters(d);c.signals.keyChanged.add(function(c,d){var e={};e[c]=d;a.setParameters(e);"theme"===c&&b(d)},this);var f=document.createElement("link");f.rel="stylesheet";f.id="theme";b(c.getKey("theme"));document.head.appendChild(f);
var g=(new NGL.ViewportWidget(a)).setId("viewport");document.body.appendChild(g.dom);var h=(new NGL.ToolbarWidget(a)).setId("toolbar");document.body.appendChild(h.dom);c=(new NGL.MenubarWidget(a,c)).setId("menubar");document.body.appendChild(c.dom);var k=(new NGL.SidebarWidget(a)).setId("sidebar");document.body.appendChild(k.dom);document.body.addEventListener("touchmove",function(a){a.preventDefault()},!1);a.handleResize();setTimeout(function(){a.handleResize()},500);var l=!1,n=!1,r=!1,p=function(b){50<=
b&&b<=window.innerWidth-10&&(k.setWidth(window.innerWidth-b+"px"),g.setWidth(b+"px"),h.setWidth(b+"px"),a.handleResize());var c=k.dom.getBoundingClientRect().width;void 0===b&&(b=window.innerWidth-c,g.setWidth(b+"px"),h.setWidth(b+"px"),a.handleResize());r=10>=c?!0:!1},p=NGL.throttle(p,50,{leading:!0,trailing:!0}),d=(new UI.Panel).setClass("ResizeLeft").onMouseDown(function(){l=!0;n=!1}).onClick(function(){r?p(window.innerWidth-300):l||n||p(window.innerWidth-10)});k.add(d);window.addEventListener("mousemove",
function(a){l&&(document.body.style.cursor="col-resize",n=!0,p(a.clientX))},!1);window.addEventListener("mouseup",function(a){l=!1;document.body.style.cursor=""},!1);window.addEventListener("resize",function(a){p()},!1);document.addEventListener("dragover",function(a){a.stopPropagation();a.preventDefault();a.dataTransfer.dropEffect="none"},!1);document.addEventListener("drop",function(a){a.stopPropagation();a.preventDefault()},!1);this.viewport=g;this.toolbar=h;this.menubar=c;this.sidebar=k;return this};
NGL.ViewportWidget=function(a){var b=a.viewer,c=new UI.Panel;c.dom=b.container;c.setPosition("absolute");c.dom.addEventListener("dragover",function(a){a.stopPropagation();a.preventDefault();a.dataTransfer.dropEffect="copy"},!1);c.dom.addEventListener("drop",function(b){b.stopPropagation();b.preventDefault();new NGL.Queue(function(b,c){a.loadFile(b,{defaultRepresentation:!0}).then(function(){c()})},b.dataTransfer.files)},!1);return c};
NGL.ToolbarWidget=function(a){var b=a.signals,c=new UI.Panel,d=(new UI.Panel).setDisplay("inline").setFloat("left"),e=(new UI.Panel).setDisplay("inline").setFloat("right");b.onPicking.add(function(a){a=a.atom?"Picked atom: "+a.atom.qualifiedName()+" ("+a.atom.structure.name+")":a.bond?"Picked bond: "+a.bond.atom1.qualifiedName()+" - "+a.bond.atom2.qualifiedName()+" ("+a.bond.structure.name+")":a.volume?"Picked volume: "+a.volume.value.toPrecision(3)+" ("+a.volume.volume.name+")":"Nothing to pick";
d.clear().add(new UI.Text(a))});a.viewer.stats.signals.updated.add(function(){e.clear();NGL.debug&&e.add(new UI.Text(a.viewer.stats.lastDuration.toFixed(2)+" ms | "+a.viewer.stats.lastFps+" fps"))});c.add(d);c.add(e);return c};
NGL.MenubarWidget=function(a,b){var c=new UI.Panel;c.add(new NGL.MenubarFileWidget(a));c.add(new NGL.MenubarViewWidget(a,b));0<NGL.ExampleRegistry.count&&c.add(new NGL.MenubarExamplesWidget(a));0<NGL.PluginRegistry.count&&c.add(new NGL.MenubarPluginsWidget(a));c.add(new NGL.MenubarHelpWidget(a,b));c.add((new UI.Panel).setClass("menu").setFloat("right").add((new UI.Text("NGL Viewer "+NGL.REVISION)).setClass("title")));return c};
NGL.MenubarFileWidget=function(a){function b(){var b=NGL.DatasourceRegistry.listing,c;c=new NGL.DirectoryListingWidget(b,a,"Import file",d,function(e){var f=e.path.split(".").pop().toLowerCase();-1!==d.indexOf(f)?(a.loadFile(b.getUrl(e.path),{defaultRepresentation:!0}),c.dispose()):NGL.log("unknown filetype: "+f)});c.setOpacity("0.9").setLeft("50px").setTop("80px").attach()}var c="pdb pdb1 ent pqr gro cif mcif mmcif sdf mol2 mmtf mrc ccp4 map cube dx dxbin obj ply ngl gz".split(" "),d=c,e=document.createElement("input");
e.type="file";e.multiple=!0;e.style.display="none";e.accept="."+c.join(",.");e.addEventListener("change",function(b){new NGL.Queue(function(b,c){a.loadFile(b,{defaultRepresentation:!0}).then(function(){c()})},b.target.files)},!1);var f=(new NGL.ExportImageWidget(a)).setDisplay("none").attach(),c=UI.MenubarHelper.createOption,g=UI.MenubarHelper.createInput,h=UI.MenubarHelper.createCheckbox,k=UI.MenubarHelper.createDivider,g=[c("Open...",function(){e.click()}),g("PDB",function(b){13===b.keyCode&&(a.loadFile("rcsb://"+
b.target.value.trim(),{defaultRepresentation:!0}),b.target.value="")}),h("asTrajectory",!1,function(b){a.defaultFileParams.asTrajectory=b.target.checked}),h("firstModelOnly",!1,function(b){a.defaultFileParams.firstModelOnly=b.target.checked}),h("cAlphaOnly",!1,function(b){a.defaultFileParams.cAlphaOnly=b.target.checked}),h("reorderAtoms",!1,function(b){a.defaultFileParams.reorderAtoms=b.target.checked}),h("dontAutoBond",!1,function(b){a.defaultFileParams.dontAutoBond=b.target.checked}),h("useWorker",
!1,function(b){a.defaultFileParams.useWorker=b.target.checked}),k(),c("Screenshot",function(){a.makeImage({factor:1,antialias:!0,trim:!1,transparent:!1}).then(function(a){NGL.download(a,"screenshot.png")})},"camera"),c("Export image...",function(){f.setOpacity("0.9").setLeft("50px").setTop("80px").setDisplay("block")})];NGL.DatasourceRegistry.listing&&g.splice(1,0,c("Import...",b));c=UI.MenubarHelper.createOptionsPanel(g);c.dom.appendChild(e);return UI.MenubarHelper.createMenuContainer("File",c)};
NGL.MenubarViewWidget=function(a,b){a.signals.fullscreenChanged.add(function(a){var b=e[3].children[0];a?b.switchClass("compress","expand"):b.switchClass("expand","compress")});var c=UI.MenubarHelper.createOption,d=UI.MenubarHelper.createDivider,e=[c("Light theme",function(){b.setKey("theme","light")}),c("Dark theme",function(){b.setKey("theme","dark")}),d(),c("Perspective",function(){a.setParameters({cameraType:"perspective"})}),c("Orthographic",function(){a.setParameters({cameraType:"orthographic"})}),
d(),c("Full screen",function(){a.toggleFullscreen(document.body)},"expand"),c("Center",function(){a.centerView()},"bullseye"),d(),c("Spin on",function(){a.setSpin([0,1,0],.005)}),c("Spin off",function(){a.setSpin(null,null)}),d(),c("Orientation",function(){window.prompt("Orientation",JSON.stringify(a.viewer.getOrientation()))})],c=UI.MenubarHelper.createOptionsPanel(e);return UI.MenubarHelper.createMenuContainer("View",c)};
...
NGL.MenubarHelpWidget=function(a,b){function c(){e.setOpacity("0.9").setLeft("50px").setTop("80px").setDisplay("block")}var d=(new NGL.PreferencesWidget(a,b)).setDisplay("none").attach(),e=(new NGL.OverviewWidget(a,b)).setDisplay("none").attach();b.getKey("overview")&&c();var f=UI.MenubarHelper.createOption,g=UI.MenubarHelper.createDivider,f=[f("Overview",c),f("Documentation",function(){window.open(NGL.documentationUrl,"_blank")}),g(),f("Debug on",function(){NGL.debug=!0;a.viewer.updateHelper();a.viewer.requestRender()}),
f("Debug off",function(){NGL.debug=!1;a.viewer.updateHelper();a.viewer.requestRender()}),g(),f("Prefereces",function(){d.setOpacity("0.9").setLeft("50px").setTop("80px").setDisplay("block")},"sliders")],f=UI.MenubarHelper.createOptionsPanel(f);return UI.MenubarHelper.createMenuContainer("Help",f)};
NGL.OverviewWidget=function(a,b){function c(a,b){var c=new UI.Panel,d=(new UI.Icon(a)).setWidth("20px").setFloat("left"),e=(new UI.Text(b)).setDisplay("inline").setMarginLeft("5px");c.setMarginLeft("20px").add(d,e);f.add(c)}var d=new UI.OverlayPanel,e=(new UI.Panel).setBorderBottom("1px solid #555").setHeight("25px"),f=(new UI.Panel).setMarginTop("10px").setMinHeight("100px").setMaxHeight("500px").setMaxWidth("600px").setOverflow("auto");e.add((new UI.Text("NGL Viewer")).setFontStyle("italic"),new UI.Html("&nbsp;&mdash;&nbsp;Overview"));
e.add((new UI.Icon("times")).setCursor("pointer").setMarginLeft("20px").setFloat("right").onClick(function(){d.setDisplay("none")}));d.add(e);d.add(f);f.add((new UI.Panel).add(new UI.Html("To load a new structure use the <i>File</i> menu in the top left via drag'n'drop."))).add(new UI.Break);f.add((new UI.Panel).add(new UI.Text("A number of clickable icons provide common actions. Most icons can be clicked on, just try it or hover the mouse pointer over it to see a tooltip."))).add(new UI.Break);c("eye",
"Controls the visibility of a component.");c("trash-o","Deletes a component. Note that a second click is required to confirm the action.");c("bullseye","Centers a component.");c("bars","Opens a menu with further options.");c("square","Opens a menu with coloring options.");c("filter","Indicates atom-selection input fields.");f.add(new UI.Text("Mouse controls")).add(new UI.Html("<ul><li>Left button hold and move to rotate camera around center.</li><li>Left button click to pick atom.</li><li>Middle button hold and move to zoom camera in and out.</li><li>Middle button click to center camera on atom.</li><li>Right button hold and move to translate camera in the screen plane.</li></ul>"));
f.add((new UI.Panel).add(new UI.Html("For more information please visit the <a href='"+NGL.documentationUrl+"' target='_blank'>documentation pages</a>.")));var e=b.getKey("overview"),g=(new UI.Checkbox(e)).onClick(function(){b.setKey("overview",g.getValue())});f.add((new UI.HorizontalRule).setBorderTop("1px solid #555").setMarginTop("15px")).add((new UI.Panel).add(g,(new UI.Text("Show on startup. Always available from Menu > Help > Overview.")).setMarginLeft("5px")));return d};
NGL.PreferencesWidget=function(a,b){var c=new UI.OverlayPanel,d=(new UI.Panel).setBorderBottom("1px solid #555").setHeight("25px"),e=(new UI.Panel).setMarginTop("10px").setMinHeight("100px").setMaxHeight("500px").setOverflow("auto");d.add(new UI.Text("Preferences"));d.add((new UI.Icon("times")).setCursor("pointer").setMarginLeft("20px").setFloat("right").onClick(function(){c.setDisplay("none")}));c.add(d);c.add(e);Object.keys(a.parameters).forEach(function(c){function d(){var a={};a[c]=k.getValue();
b.setKey(c,a[c])}var h=a.parameters[c];void 0===h.label&&(h.label=c);var k=NGL.createParameterInput(h);if(k){b.signals.keyChanged.add(function(a,b){a===c&&k.setValue(b)});if("range"===h.type)k.onInput(d);else k.onChange(d);e.add((new UI.Text(c)).setWidth("120px")).add(k).add(new UI.Break)}});return c};
...
c.add(e);var f=(new UI.Select).setOptions({1:"1x",2:"2x",3:"3x",4:"4x",5:"5x",6:"6x",7:"7x",8:"8x",9:"9x",10:"10x"}).setValue("4"),g=(new UI.Checkbox).setValue(!0),h=(new UI.Checkbox).setValue(!1),k=(new UI.Checkbox).setValue(!1),l=(new UI.Progress).setDisplay("none"),n=(new UI.Button("export")).onClick(function(){function b(a,c,d){1===a&&l.setMax(c);a>=c?l.setIndeterminate():l.setValue(a);d&&(l.setDisplay("none"),n.setDisplay("inline-block"))}n.setDisplay("none");l.setDisplay("inline-block");setTimeout(function(){a.makeImage({factor:parseInt(f.getValue()),
antialias:g.getValue(),trim:h.getValue(),transparent:k.getValue(),onProgress:b}).then(function(a){NGL.download(a,"screenshot.png")})},50)});b("scale",f);b("antialias",g);b("trim",h);b("transparent",k);e.add(new UI.Break,n,l);return c};
...
k=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){a.removeAllComponents()}),l=(new UI.PopupMenu("cogs","Settings","window")).setIconTitle("settings").setMarginLeft("10px");l.entryLabelWidth="120px";var n=(new UI.Panel).setDisplay("inline").add((new UI.Icon("spinner")).addClass("spin").setMarginLeft("45px"));a.tasks.signals.countChanged.add(function(a,b){if(0<b)r.add(n);else try{r.remove(n)}catch(c){}});"clipNear clipFar clipDist fogNear fogFar lightColor lightIntensity ambientColor ambientIntensity".split(" ").forEach(function(b){function c(){var d=
{};d[b]=e.getValue();a.setParameters(d)}var d=a.parameters[b];void 0===d.label&&(d.label=b);var e=NGL.createParameterInput(d);if(e){a.signals.parametersChanged.add(function(a){e.setValue(a[b])});if("range"===d.type)e.onInput(c);else e.onChange(c);l.addEntry(b,e)}});var r=(new UI.Panel).setClass("Panel Sticky").add(b,g,h,k,l);c.add(r,d);return c};
NGL.ComponentWidget=function(a,b){var c=a.signals,d=new UI.CollapsibleIconPanel("minus-square","plus-square");c.statusChanged.add(function(b){b={404:"Error: file not found"}[a.status]||a.status;d.setCollapsed(!1);d.add((new UI.Text(b)).setMarginLeft("20px").setWidth("200px").setWordWrap("break-word"));d.removeStatic(e);d.addStatic(f)});var c=(new UI.EllipsisText(NGL.unicodeHelper(a.name))).setWidth("100px"),e=(new UI.Panel).setDisplay("inline").add((new UI.Icon("spinner")).addClass("spin").setMarginLeft("25px")),
f=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){b.removeComponent(a)});d.addStatic(c,e);return d};
NGL.StructureComponentWidget=function(a,b){function c(){var c={"":"[ structure ]"};b.eachComponent(function(b,d){b!==a&&(c[d]=NGL.unicodeHelper(b.name))},NGL.StructureComponent);p.setOptions(c)}var d=a.signals,e=new UI.CollapsibleIconPanel("minus-square","plus-square"),f=new UI.Panel,g=new UI.Panel;d.representationAdded.add(function(a){f.add(new NGL.RepresentationComponentWidget(a,b))});d.trajectoryAdded.add(function(a){g.add(new NGL.TrajectoryComponentWidget(a,b))});d.defaultAssemblyChanged.add(function(){k.setValue(a.defaultAssembly)});
e.add((new UI.SelectionPanel(a.selection)).setMarginLeft("20px").setInputWidth("214px"));var d=(new UI.Button("export")).onClick(function(){(new NGL.PdbWriter(a.structure)).download("structure");m.setMenuDisplay("none")}),h=(new UI.Select).setColor("#444").setOptions(function(){var a={"":"[ add ]"},b;for(b in NGL.representationTypes)a[b]=b;return a}()).onChange(function(){a.addRepresentation(h.getValue());h.setValue("");m.setMenuDisplay("none")}),k=(new UI.Select).setColor("#444").setOptions(function(){var b=
{"":a.structure.unitcell?"AU":"FULL"};Object.keys(a.structure.biomolDict).forEach(function(a){b[a]=a});return b}()).setValue(a.defaultAssembly).onChange(function(){a.setDefaultAssembly(k.getValue());m.setMenuDisplay("none")}),l=document.createElement("input");l.type="file";l.multiple=!0;l.style.display="none";l.accept=".dcd,.dcd.gz";l.addEventListener("change",function(b){new NGL.Queue(function(b,c){var d=NGL.autoLoad(b).then(function(a){c();return a});a.addTrajectory(d)},b.target.files)},!1);var n=
(new UI.Button("import")).onClick(function(){l.click();m.setMenuDisplay("none")}),r=(new UI.Button("import")).onClick(function(){m.setMenuDisplay("none");var c=["xtc","trr","dcd","netcdf","nc"],d;d=new NGL.DirectoryListingWidget(NGL.DatasourceRegistry.listing,b,"Import trajectory",c,function(b){var e=b.path.split(".").pop().toLowerCase();-1!==c.indexOf(e)?(a.addTrajectory(b.path),d.dispose()):NGL.log("unknown trajectory type: "+e)});d.setOpacity("0.9").setLeft("50px").setTop("80px").attach()});b.signals.componentAdded.add(c);
b.signals.componentRemoved.add(c);var p=(new UI.Select).setColor("#444").onChange(function(){a.superpose(b.compList[p.getValue()],!0);a.centerView();p.setValue("");m.setMenuDisplay("none")});c();var s=(new UI.Button("calculate")).onClick(function(){NGL.calculateSecondaryStructure(a.structure);a.rebuildRepresentations();m.setMenuDisplay("none")}),m=(new UI.ComponentPanel(a)).setDisplay("inline-block").setMargin("0px").addMenuEntry("PDB file",d).addMenuEntry("Representation",h).addMenuEntry("Assembly",
k).addMenuEntry("Superpose",p).addMenuEntry("SS",s).addMenuEntry("File",(new UI.Text(a.structure.path)).setMaxWidth("100px").setOverflow("auto")).addMenuEntry("Trajectory",n);NGL.DatasourceRegistry.listing&&NGL.DatasourceRegistry.trajectory&&m.addMenuEntry("Remote trajectory",r);e.addStatic(m).add(g).add(f);return e};
NGL.SurfaceComponentWidget=function(a,b){var c=a.signals,d=new UI.CollapsibleIconPanel("minus-square","plus-square"),e=new UI.Panel;c.representationAdded.add(function(a){e.add(new NGL.RepresentationComponentWidget(a,b))});var f=(new UI.Select).setColor("#444").setOptions({"":"[ add ]",surface:"surface",dot:"dot"}).onChange(function(){a.addRepresentation(f.getValue());f.setValue("");g.setMenuDisplay("none")}),g=(new UI.ComponentPanel(a)).setDisplay("inline-block").setMargin("0px").addMenuEntry("Representation",
f).addMenuEntry("File",(new UI.Text(a.surface.path)).setMaxWidth("100px").setWordWrap("break-word"));d.addStatic(g).add(e);return d};
NGL.ScriptComponentWidget=function(a,b){var c=a.signals,d=new UI.CollapsibleIconPanel("minus-square","plus-square"),e=(new UI.Panel).setMarginLeft("20px");c.nameChanged.add(function(a){g.setValue(NGL.unicodeHelper(a))});c.statusChanged.add(function(a){"finished"===a&&(d.removeStatic(h),d.addStatic(f))});a.script.signals.elementAdded.add(function(a){e.add.apply(e,a)});a.script.signals.elementRemoved.add(function(a){e.remove.apply(e,a)});var f=(new UI.DisposeIcon).setMarginLeft("10px").setDisposeFunction(function(){b.removeComponent(a)}),
...
var k=a.repr,l=k.getParameters();Object.keys(k.parameters).forEach(function(b){function d(){var c={};c[b]=f.getValue();a.setParameters(c);k.viewer.requestRender()}if(k.parameters[b]){var e=Object.assign({},k.parameters[b]);e.value=l[b];void 0===e.label&&(e.label=b);var f=NGL.createParameterInput(e);if(f){c.parametersChanged.add(function(a){f.setValue(a[b])});if("range"===e.type)f.onInput(d);else f.onChange(d);h.addEntry(b,f)}}});d.addStatic(h);return d};
NGL.TrajectoryComponentWidget=function(a,b){function c(a){h.clear().add(l.setWidth("70px"));l.setRange(-1,a-1);r.setRange(-1,a-1);n.setValue(Math.ceil((a+1)/100));q.step=n.getValue();q.end=a}var d=a.signals,e=a.trajectory,f=(new UI.CollapsibleIconPanel("minus-square","plus-square")).setMarginLeft("20px"),g=new UI.Panel;d.representationAdded.add(function(a){g.add(new NGL.RepresentationComponentWidget(a,b))});d.disposed.add(function(){x.dispose();f.dispose()});var h=(new UI.Panel).setMarginLeft("10px").setDisplay("inline").add((new UI.Icon("spinner")).addClass("spin").setMarginRight("69px"));
d.gotNumframes.add(c);d.frameChanged.add(function(a){l.setValue(a);r.setValue(a);h.clear().add(l.setWidth("70px"))});var k=(new UI.EllipsisText(e.name)).setWidth("108px");f.addStatic(k);f.addStatic(h);var l=(new UI.Integer(-1)).setMarginLeft("5px").setWidth("70px").setRange(-1,-1).onChange(function(a){e.setFrame(l.getValue());x.setMenuDisplay("none")}),n=(new UI.Integer(1)).setWidth("30px").setRange(1,1E4).onChange(function(){q.step=n.getValue()}),k=new UI.Panel,r=(new UI.Range(-1,-1,-1,1)).setWidth("197px").setMargin("0px").setPadding("0px").setBorder("0px").onInput(function(a){a=
r.getValue();a!==e.currentFrame&&(e.player&&e.player._running?(e.setPlayer(),e.setFrame(a)):e.inProgress||e.setFrame(a))}),p=(new UI.Select).setColor("#444").setOptions({"":"none",linear:"linear",spline:"spline"}).onChange(function(){q.interpolateType=p.getValue()}),s=(new UI.Integer(5)).setWidth("30px").setRange(1,50).onChange(function(){q.interpolateStep=s.getValue()}),m=(new UI.Integer(50)).setWidth("30px").setRange(10,1E3).onChange(function(){q.timeout=m.getValue()}),q=new NGL.TrajectoryPlayer(e,
n.getValue(),m.getValue(),0,e.numframes),t=(new UI.ToggleIcon(!0,"play","pause")).setMarginRight("10px").setMarginLeft("20px").setCursor("pointer").setWidth("12px").setTitle("play").onClick(function(){q.toggle()});q.signals.startedRunning.add(function(){t.setTitle("pause").setValue(!1)});q.signals.haltedRunning.add(function(){t.setTitle("play").setValue(!0)});k.add(t);k.add(r);var y=(new UI.Select).setColor("#444").setOptions({forward:"forward",backward:"backward"}).onChange(function(){q.direction=
y.getValue()}),z=(new UI.Select).setColor("#444").setOptions({loop:"loop",once:"once"}).onChange(function(){q.mode=z.getValue()});f.add((new UI.SelectionPanel(e.selection)).setMarginLeft("20px").setInputWidth("194px"));var u=(new UI.Checkbox(e.params.centerPbc)).onChange(function(){a.setParameters({centerPbc:u.getValue()})}),v=(new UI.Checkbox(e.params.removePbc)).onChange(function(){a.setParameters({removePbc:v.getValue()})}),w=(new UI.Checkbox(e.params.superpose)).onChange(function(){a.setParameters({superpose:w.getValue()})});
d.parametersChanged.add(function(a){u.setValue(a.centerPbc);v.setValue(a.removePbc);w.setValue(a.superpose)});(new UI.Button("download")).onClick(function(){e.download(n.getValue())});var d=(new UI.Button("add")).onClick(function(){a.addRepresentation()}),A=(new UI.DisposeIcon).setDisposeFunction(function(){a.parent.removeTrajectory(a)});e.numframes&&c(e.numframes);var x=(new UI.PopupMenu("bars","Trajectory")).setMarginLeft("10px").setEntryLabelWidth("130px").addEntry("Path",d).addEntry("Center",
u).addEntry("Remove PBC",v).addEntry("Superpose",w).addEntry("Step size",n).addEntry("Interpolation type",p).addEntry("Interpolation steps",s).addEntry("Play timeout",m).addEntry("Play direction",y).addEntry("Play mode",z).addEntry("File",(new UI.Text(e.trajPath)).setMaxWidth("100px").setWordWrap("break-word")).addEntry("Dispose",A);f.addStatic(x);f.add(k);f.add(g);return f};
NGL.DirectoryListingWidget=function(a,b,c,d,e){function f(a,b,c,d,e){return(b=Math,c=b.log,d=1E3,e=c(a)/c(d)|0,a/b.pow(d,e)).toFixed(2)+String.fromCharCode(160)+(e?"kMGTPEZY"[--e]+"B":"Bytes")}function g(a){var b={"":""},c=[];(a||"").split("/").forEach(function(a){c.push(a);b[c.join("/")]=a});return b}function h(b){var c=b.path;b=b.data;NGL.lastUsedDirectory=c;l.clear();n.setOptions(g(c)).setValue(c);b.forEach(function(b){var c=b.path.split(".").pop().toLowerCase();if(!d||b.dir||-1!==d.indexOf(c)){var g;
b.dir?(c="folder-o",g=b.name):(c="file-o",g=b.name+String.fromCharCode(160)+"("+f(b.size)+")");c=(new UI.Panel).setDisplay("block").setWhiteSpace("nowrap").add((new UI.Icon(c)).setWidth("20px")).add(new UI.Text(g)).onClick(function(){b.dir?a.getListing(b.path).then(h):e(b)});b.restricted&&c.add((new UI.Icon("lock")).setMarginLeft("5px"));l.add(c)}})}var k=new UI.OverlayPanel;b=(new UI.Panel).setBorderBottom("1px solid #555").setHeight("30px");var l=(new UI.Panel).setMarginTop("10px").setMinHeight("100px").setMaxHeight("500px").setPaddingRight("15px").setOverflow("auto"),
n=(new UI.Select).setColor("#444").setMarginLeft("20px").setWidth("").setMaxWidth("200px").setOptions(g()).onChange(function(){a.getListing(n.getValue()).then(h)});b.add(new UI.Text(c||"Directoy listing"));b.add(n);b.add((new UI.Icon("times")).setCursor("pointer").setMarginLeft("20px").setFloat("right").onClick(function(){k.dispose()}));k.add(b);k.add(l);a.getListing(NGL.lastUsedDirectory).then(h);return k};
