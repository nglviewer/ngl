...
THREE.ManualMSAARenderPass.prototype = {
	...
	render: function ( renderer, writeBuffer, readBuffer, delta ) {
		...
		this.materialComposite.needsUpdate = true;
		...
		for ( var i = 0; i < jitterOffsets.length; i ++ ) {
			...
			if ( camera.setViewOffset ) {
				// jitterOffset[ 0 ] = Math.random() * 16 - 8;
				// jitterOffset[ 1 ] = Math.random() * 16 - 8;
				// jitterOffset[ 0 ] = 0;
				// jitterOffset[ 1 ] = 0;
				// console.log( jitterOffset[ 0 ] * 0.0625, jitterOffset[ 1 ] * 0.0625 )
				// console.log( readBuffer.width, readBuffer.height )
			...
			renderer.render( this.scene2, this.camera2, this.holdRenderTarget, ( i === 0 ) );
		...
		// this.holdRenderTarget.texture.needsUpdate = true;
		this.materialComposite.needsUpdate = true;
