...
Clazz.load (["J.render.ShapeRenderer", "JU.P3", "$.P3i", "$.V3"], "J.renderspecial.VectorsRenderer", ["J.api.JmolModulationSet", "J.shape.Shape", "JU.Vibration"], function () {
...
var isMod = (Clazz.instanceOf (vib, J.api.JmolModulationSet));
this.drawCap = true;
if (!isMod) {
var len = vib.length ();
