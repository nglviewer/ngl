...
if (this.vwr.getTestFlag (2)) {
this.rotateXRadians (degY * 0.017453292, bsAtoms);
this.rotateYRadians (degX * 0.017453292, bsAtoms);
} else {
...
this.matrixTemp3.setAsBallRotation (0.017453292, -yDeg, -xDeg);
