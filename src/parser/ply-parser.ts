 ...
 */
 ...
 class Face3 {
  ...
  materialIndex: any;
	...
	createSingle( a: any, b: any, c: any, normal : Vector3, color: Color, materialIndex = 0 ) {
  ...
  createMultiple( a: any, b: any, c: any, normal : Vector3[], color: Color[], materialIndex = 0 ) {
 ...
 PLYLoader.prototype = {
   ...
   handleElement: function (geometry: GeometryPLY, elementName: string, element: PLYElement) {
     ...
     if (geometry.vertices == null) geometry.vertices = [];
     ...
     if (elementName === 'vertex') {
       ...
       if (vertexIndices.length === 3) {
         ...
         var face1 = new Face3();
         var face2 = new Face3();
         face1.createSingle(vertexIndices[ 0 ], vertexIndices[ 1 ], vertexIndices[ 3 ], new Vector3(), new Color(), -1);
         face2.createSingle(vertexIndices[ 1 ], vertexIndices[ 2 ], vertexIndices[ 3 ], new Vector3(), new Color(), -1);
   ...
   toBufferGeometry: function(data: GeometryPLY) {
