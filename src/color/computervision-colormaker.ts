/**
 * @file ComputerVision Colormaker
...
//import { defaults } from '../utils' , { StuctureColormakerParams, ColormakerScale }
import AtomProxy from '../proxy/atom-proxy'
//import ChainProxy from '../proxy/chain-proxy'

import StringStreamer from '../../src/streamer/file-streamer'
import CsvParser from '../parser/csv-parser'

import path from 'path'
import fs from 'fs'

  var file = path.join(__dirname, '/../data/2ISK.csv')
  var str = fs.readFileSync(file, 'utf-8')
  var streamer = new StringStreamer(str)
  var csvParser = new CsvParser(streamer, {delimiter:',', comment:'#', columnNames: true}) 
